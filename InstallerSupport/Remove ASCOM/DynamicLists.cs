...
// This class is dynamically generated by the MakeDynamicLists Program.
// Do not alter this class, alter the MakeDynamicLists program instead and your changes will appear when the next build is made.
...
namespace RemoveASCOM
{
    ...
    class DynamicLists
    {
        ...
        public static SortedList<string, string> GUIDs(TraceLogger TL)
        {
            SortedList<string, string> guidList;
            guidList = new SortedList<string, string>();
            try
            {
        ...
        public static SortedSet<string> PlatformFiles(TraceLogger TL)
        {
            SortedSet<string> fileList;
            fileList = new SortedSet<string>();
            try
            {
                fileList.Add(@"$COMMONFILES$\ASCOM\.net\ASCOM.DriverAccess.dll");
                TL.LogMessage("PlatformFiles", @"Added file: $COMMONFILES$\ASCOM\.net\ASCOM.DriverAccess.dll");
            }
            catch (Exception ex)
            {
                TL.LogMessage("PlatformFiles", "Exception: " + ex.ToString());
            }
            try
            {
                fileList.Add(@"$COMMONFILES$\ASCOM\.net\ASCOM.Utilities.dll");
                TL.LogMessage("PlatformFiles", @"Added file: $COMMONFILES$\ASCOM\.net\ASCOM.Utilities.dll");
            }
            catch (Exception ex)
            {
                TL.LogMessage("PlatformFiles", "Exception: " + ex.ToString());
            ...
            try
            {
                fileList.Add(@"$COMMONFILES$\ASCOM\.net\These files are not in use - ReadMe.txt");
                TL.LogMessage("PlatformFiles", @"Added file: $COMMONFILES$\ASCOM\.net\These files are not in use - ReadMe.txt");
            }
            catch (Exception ex)
            {
                TL.LogMessage("PlatformFiles", "Exception: " + ex.ToString());
            ...
            try
            {
                fileList.Add(@"$COMMONFILES$\ASCOM\Astrometry\cio_ra.bin");
                TL.LogMessage("PlatformFiles", @"Added file: $COMMONFILES$\ASCOM\Astrometry\cio_ra.bin");
            }
            catch (Exception ex)
            {
                TL.LogMessage("PlatformFiles", "Exception: " + ex.ToString());
            ...
            try
            {
                fileList.Add(@"$COMMONFILES$\ASCOM\Astrometry\JPLEPH");
                TL.LogMessage("PlatformFiles", @"Added file: $COMMONFILES$\ASCOM\Astrometry\JPLEPH");
            }
            catch (Exception ex)
            {
                TL.LogMessage("PlatformFiles", "Exception: " + ex.ToString());
            ...
            try
            {
                fileList.Add(@"$COMMONFILES$\ASCOM\Astrometry\NOVAS3.dll");
                TL.LogMessage("PlatformFiles", @"Added file: $COMMONFILES$\ASCOM\Astrometry\NOVAS3.dll");
            }
            catch (Exception ex)
            {
                TL.LogMessage("PlatformFiles", "Exception: " + ex.ToString());
            ...
            try
            {
                fileList.Add(@"$COMMONFILES$\ASCOM\Astrometry\NOVAS3.pdb");
                TL.LogMessage("PlatformFiles", @"Added file: $COMMONFILES$\ASCOM\Astrometry\NOVAS3.pdb");
            }
            catch (Exception ex)
            {
                TL.LogMessage("PlatformFiles", "Exception: " + ex.ToString());
            ...
            try
            {
                fileList.Add(@"$COMMONFILES$\ASCOM\Astrometry\NOVAS31.dll");
                TL.LogMessage("PlatformFiles", @"Added file: $COMMONFILES$\ASCOM\Astrometry\NOVAS31.dll");
            }
            catch (Exception ex)
            {
                TL.LogMessage("PlatformFiles", "Exception: " + ex.ToString());
            ...
            try
            {
                fileList.Add(@"$COMMONFILES$\ASCOM\Astrometry\NOVAS31.pdb");
                TL.LogMessage("PlatformFiles", @"Added file: $COMMONFILES$\ASCOM\Astrometry\NOVAS31.pdb");
            }
            catch (Exception ex)
            {
                TL.LogMessage("PlatformFiles", "Exception: " + ex.ToString());
            ...
            try
            {
                fileList.Add(@"$COMMONFILES$\ASCOM\Astrometry\NOVAS31-64.dll");
                TL.LogMessage("PlatformFiles", @"Added file: $COMMONFILES$\ASCOM\Astrometry\NOVAS31-64.dll");
            }
            catch (Exception ex)
            {
                TL.LogMessage("PlatformFiles", "Exception: " + ex.ToString());
            ...
            try
            {
                fileList.Add(@"$COMMONFILES$\ASCOM\Astrometry\NOVAS31-64.pdb");
                TL.LogMessage("PlatformFiles", @"Added file: $COMMONFILES$\ASCOM\Astrometry\NOVAS31-64.pdb");
            }
            catch (Exception ex)
            {
                TL.LogMessage("PlatformFiles", "Exception: " + ex.ToString());
            ...
            try
            {
                fileList.Add(@"$COMMONFILES$\ASCOM\Astrometry\NOVAS3-64.dll");
                TL.LogMessage("PlatformFiles", @"Added file: $COMMONFILES$\ASCOM\Astrometry\NOVAS3-64.dll");
            }
            catch (Exception ex)
            {
                TL.LogMessage("PlatformFiles", "Exception: " + ex.ToString());
            ...
            try
            {
                fileList.Add(@"$COMMONFILES$\ASCOM\Astrometry\NOVAS3-64.pdb");
                TL.LogMessage("PlatformFiles", @"Added file: $COMMONFILES$\ASCOM\Astrometry\NOVAS3-64.pdb");
            }
            catch (Exception ex)
            {
                TL.LogMessage("PlatformFiles", "Exception: " + ex.ToString());
            ...
            try
            {
                fileList.Add(@"$COMMONFILES$\ASCOM\Astrometry\NOVAS-C.dll");
                TL.LogMessage("PlatformFiles", @"Added file: $COMMONFILES$\ASCOM\Astrometry\NOVAS-C.dll");
            }
            catch (Exception ex)
            {
                TL.LogMessage("PlatformFiles", "Exception: " + ex.ToString());
            ...
            try
            {
                fileList.Add(@"$COMMONFILES$\ASCOM\Astrometry\NOVAS-C.pdb");
                TL.LogMessage("PlatformFiles", @"Added file: $COMMONFILES$\ASCOM\Astrometry\NOVAS-C.pdb");
            }
            catch (Exception ex)
            {
                TL.LogMessage("PlatformFiles", "Exception: " + ex.ToString());
            ...
            try
            {
                fileList.Add(@"$COMMONFILES$\ASCOM\Astrometry\NOVAS-C64.dll");
                TL.LogMessage("PlatformFiles", @"Added file: $COMMONFILES$\ASCOM\Astrometry\NOVAS-C64.dll");
            }
            catch (Exception ex)
            {
                TL.LogMessage("PlatformFiles", "Exception: " + ex.ToString());
            ...
            try
            {
                fileList.Add(@"$COMMONFILES$\ASCOM\Astrometry\NOVAS-C64.pdb");
                TL.LogMessage("PlatformFiles", @"Added file: $COMMONFILES$\ASCOM\Astrometry\NOVAS-C64.pdb");
            }
            catch (Exception ex)
            {
                TL.LogMessage("PlatformFiles", "Exception: " + ex.ToString());
            ...
            try
            {
                fileList.Add(@"$COMMONFILES$\ASCOM\Camera\ASCOM.Simulator.Camera\ASCOM.Simulator.Camera.dll");
                TL.LogMessage("PlatformFiles", @"Added file: $COMMONFILES$\ASCOM\Camera\ASCOM.Simulator.Camera\ASCOM.Simulator.Camera.dll");
            }
            catch (Exception ex)
            {
                TL.LogMessage("PlatformFiles", "Exception: " + ex.ToString());
            ...
            try
            {
                fileList.Add(@"$COMMONFILES$\ASCOM\Camera\ASCOM.Simulator.Camera\ASCOM.Simulator.Camera.pdb");
                TL.LogMessage("PlatformFiles", @"Added file: $COMMONFILES$\ASCOM\Camera\ASCOM.Simulator.Camera\ASCOM.Simulator.Camera.pdb");
            }
            catch (Exception ex)
            {
                TL.LogMessage("PlatformFiles", "Exception: " + ex.ToString());
            ...
            try
            {
                fileList.Add(@"$COMMONFILES$\ASCOM\Camera\ASCOM.Simulator.Camera\M42-800x600.jpg");
                TL.LogMessage("PlatformFiles", @"Added file: $COMMONFILES$\ASCOM\Camera\ASCOM.Simulator.Camera\M42-800x600.jpg");
            }
            catch (Exception ex)
            {
                TL.LogMessage("PlatformFiles", "Exception: " + ex.ToString());
            ...
            try
            {
                fileList.Add(@"$COMMONFILES$\ASCOM\Camera\ASCOM.Simulator.Camera\Testcard_F.jpg");
                TL.LogMessage("PlatformFiles", @"Added file: $COMMONFILES$\ASCOM\Camera\ASCOM.Simulator.Camera\Testcard_F.jpg");
            }
            catch (Exception ex)
            {
                TL.LogMessage("PlatformFiles", "Exception: " + ex.ToString());
            ...
            try
            {
                fileList.Add(@"$COMMONFILES$\ASCOM\Camera\CCDSimulator.dll");
                TL.LogMessage("PlatformFiles", @"Added file: $COMMONFILES$\ASCOM\Camera\CCDSimulator.dll");
            }
            catch (Exception ex)
            {
                TL.LogMessage("PlatformFiles", "Exception: " + ex.ToString());
            ...
            try
            {
                fileList.Add(@"$COMMONFILES$\ASCOM\Camera\unuran-0.6.0.dll");
                TL.LogMessage("PlatformFiles", @"Added file: $COMMONFILES$\ASCOM\Camera\unuran-0.6.0.dll");
            }
            catch (Exception ex)
            {
                TL.LogMessage("PlatformFiles", "Exception: " + ex.ToString());
            ...
            try
            {
                fileList.Add(@"$COMMONFILES$\ASCOM\Camera\UNURANReadMe.txt");
                TL.LogMessage("PlatformFiles", @"Added file: $COMMONFILES$\ASCOM\Camera\UNURANReadMe.txt");
            }
            catch (Exception ex)
            {
                TL.LogMessage("PlatformFiles", "Exception: " + ex.ToString());
            ...
            try
            {
                fileList.Add(@"$COMMONFILES$\ASCOM\Dome\ASCOM.Simulator.Dome\ASCOM.Simulator.Dome.dll");
                TL.LogMessage("PlatformFiles", @"Added file: $COMMONFILES$\ASCOM\Dome\ASCOM.Simulator.Dome\ASCOM.Simulator.Dome.dll");
            }
            catch (Exception ex)
            {
                TL.LogMessage("PlatformFiles", "Exception: " + ex.ToString());
            ...
            try
            {
                fileList.Add(@"$COMMONFILES$\ASCOM\Dome\ASCOM.Simulator.Dome\ASCOM.Simulator.Dome.pdb");
                TL.LogMessage("PlatformFiles", @"Added file: $COMMONFILES$\ASCOM\Dome\ASCOM.Simulator.Dome\ASCOM.Simulator.Dome.pdb");
            }
            catch (Exception ex)
            {
                TL.LogMessage("PlatformFiles", "Exception: " + ex.ToString());
            ...
            try
            {
                fileList.Add(@"$COMMONFILES$\ASCOM\Dome\ASCOMDome.exe");
                TL.LogMessage("PlatformFiles", @"Added file: $COMMONFILES$\ASCOM\Dome\ASCOMDome.exe");
            }
            catch (Exception ex)
            {
                TL.LogMessage("PlatformFiles", "Exception: " + ex.ToString());
            ...
            try
            {
                fileList.Add(@"$COMMONFILES$\ASCOM\Dome\Astro32.dll");
                TL.LogMessage("PlatformFiles", @"Added file: $COMMONFILES$\ASCOM\Dome\Astro32.dll");
            }
            catch (Exception ex)
            {
                TL.LogMessage("PlatformFiles", "Exception: " + ex.ToString());
            ...
            try
            {
                fileList.Add(@"$COMMONFILES$\ASCOM\Dome\DomeSim.exe");
                TL.LogMessage("PlatformFiles", @"Added file: $COMMONFILES$\ASCOM\Dome\DomeSim.exe");
            }
            catch (Exception ex)
            {
                TL.LogMessage("PlatformFiles", "Exception: " + ex.ToString());
            ...
            try
            {
                fileList.Add(@"$COMMONFILES$\ASCOM\FilterWheel\ASCOM.FilterWheelSim\ASCOM.FilterWheelSim.exe");
                TL.LogMessage("PlatformFiles", @"Added file: $COMMONFILES$\ASCOM\FilterWheel\ASCOM.FilterWheelSim\ASCOM.FilterWheelSim.exe");
            }
            catch (Exception ex)
            {
                TL.LogMessage("PlatformFiles", "Exception: " + ex.ToString());
            ...
            try
            {
                fileList.Add(@"$COMMONFILES$\ASCOM\FilterWheel\ASCOM.FilterWheelSim\ASCOM.FilterWheelSim.pdb");
                TL.LogMessage("PlatformFiles", @"Added file: $COMMONFILES$\ASCOM\FilterWheel\ASCOM.FilterWheelSim\ASCOM.FilterWheelSim.pdb");
            }
            catch (Exception ex)
            {
                TL.LogMessage("PlatformFiles", "Exception: " + ex.ToString());
            ...
            try
            {
                fileList.Add(@"$COMMONFILES$\ASCOM\FilterWheel\ASCOM.FilterWheelSim\ASCOM.Simulator.FilterWheel.dll");
                TL.LogMessage("PlatformFiles", @"Added file: $COMMONFILES$\ASCOM\FilterWheel\ASCOM.FilterWheelSim\ASCOM.Simulator.FilterWheel.dll");
            }
            catch (Exception ex)
            {
                TL.LogMessage("PlatformFiles", "Exception: " + ex.ToString());
            ...
            try
            {
                fileList.Add(@"$COMMONFILES$\ASCOM\FilterWheel\ASCOM.FilterWheelSim\ASCOM.Simulator.FilterWheel.pdb");
                TL.LogMessage("PlatformFiles", @"Added file: $COMMONFILES$\ASCOM\FilterWheel\ASCOM.FilterWheelSim\ASCOM.Simulator.FilterWheel.pdb");
            }
            catch (Exception ex)
            {
                TL.LogMessage("PlatformFiles", "Exception: " + ex.ToString());
            ...
            try
            {
                fileList.Add(@"$COMMONFILES$\ASCOM\FilterWheel\FilterWheelSim.exe");
                TL.LogMessage("PlatformFiles", @"Added file: $COMMONFILES$\ASCOM\FilterWheel\FilterWheelSim.exe");
            }
            catch (Exception ex)
            {
                TL.LogMessage("PlatformFiles", "Exception: " + ex.ToString());
            ...
            try
            {
                fileList.Add(@"$COMMONFILES$\ASCOM\Focuser\ASCOM.Simulator.Focuser\ASCOM.Simulator.Focuser.dll");
                TL.LogMessage("PlatformFiles", @"Added file: $COMMONFILES$\ASCOM\Focuser\ASCOM.Simulator.Focuser\ASCOM.Simulator.Focuser.dll");
            }
            catch (Exception ex)
            {
                TL.LogMessage("PlatformFiles", "Exception: " + ex.ToString());
            ...
            try
            {
                fileList.Add(@"$COMMONFILES$\ASCOM\Focuser\ASCOM.Simulator.Focuser\ASCOM.Simulator.Focuser.pdb");
                TL.LogMessage("PlatformFiles", @"Added file: $COMMONFILES$\ASCOM\Focuser\ASCOM.Simulator.Focuser\ASCOM.Simulator.Focuser.pdb");
            }
            catch (Exception ex)
            {
                TL.LogMessage("PlatformFiles", "Exception: " + ex.ToString());
            ...
            try
            {
                fileList.Add(@"$COMMONFILES$\ASCOM\Focuser\FocusSim.exe");
                TL.LogMessage("PlatformFiles", @"Added file: $COMMONFILES$\ASCOM\Focuser\FocusSim.exe");
            }
            catch (Exception ex)
            {
                TL.LogMessage("PlatformFiles", "Exception: " + ex.ToString());
            ...
            try
            {
                fileList.Add(@"$COMMONFILES$\ASCOM\Helper.dll");
                TL.LogMessage("PlatformFiles", @"Added file: $COMMONFILES$\ASCOM\Helper.dll");
            }
            catch (Exception ex)
            {
                TL.LogMessage("PlatformFiles", "Exception: " + ex.ToString());
            ...
            try
            {
                fileList.Add(@"$COMMONFILES$\ASCOM\Helper2.dll");
                TL.LogMessage("PlatformFiles", @"Added file: $COMMONFILES$\ASCOM\Helper2.dll");
            }
            catch (Exception ex)
            {
                TL.LogMessage("PlatformFiles", "Exception: " + ex.ToString());
            ...
            try
            {
                fileList.Add(@"$COMMONFILES$\ASCOM\Interface\AscomMasterInterfaces.tlb");
                TL.LogMessage("PlatformFiles", @"Added file: $COMMONFILES$\ASCOM\Interface\AscomMasterInterfaces.tlb");
            }
            catch (Exception ex)
            {
                TL.LogMessage("PlatformFiles", "Exception: " + ex.ToString());
            ...
            try
            {
                fileList.Add(@"$COMMONFILES$\ASCOM\Interface\Helper.tlb");
                TL.LogMessage("PlatformFiles", @"Added file: $COMMONFILES$\ASCOM\Interface\Helper.tlb");
            }
            catch (Exception ex)
            {
                TL.LogMessage("PlatformFiles", "Exception: " + ex.ToString());
            ...
            try
            {
                fileList.Add(@"$COMMONFILES$\ASCOM\Interface\Helper2.tlb");
                TL.LogMessage("PlatformFiles", @"Added file: $COMMONFILES$\ASCOM\Interface\Helper2.tlb");
            }
            catch (Exception ex)
            {
                TL.LogMessage("PlatformFiles", "Exception: " + ex.ToString());
            ...
            try
            {
                fileList.Add(@"$COMMONFILES$\ASCOM\Interface\IObjectSafety.tlb");
                TL.LogMessage("PlatformFiles", @"Added file: $COMMONFILES$\ASCOM\Interface\IObjectSafety.tlb");
            }
            catch (Exception ex)
            {
                TL.LogMessage("PlatformFiles", "Exception: " + ex.ToString());
            ...
            try
            {
                fileList.Add(@"$COMMONFILES$\ASCOM\Platform\ASCOM.ico");
                TL.LogMessage("PlatformFiles", @"Added file: $COMMONFILES$\ASCOM\Platform\ASCOM.ico");
            }
            catch (Exception ex)
            {
                TL.LogMessage("PlatformFiles", "Exception: " + ex.ToString());
            ...
            try
            {
                fileList.Add(@"$COMMONFILES$\ASCOM\Platform\Help.ico");
                TL.LogMessage("PlatformFiles", @"Added file: $COMMONFILES$\ASCOM\Platform\Help.ico");
            }
            catch (Exception ex)
            {
                TL.LogMessage("PlatformFiles", "Exception: " + ex.ToString());
            ...
            try
            {
                fileList.Add(@"$COMMONFILES$\ASCOM\Platform\Internal\ASCOM.Internal.GACInstall.exe");
                TL.LogMessage("PlatformFiles", @"Added file: $COMMONFILES$\ASCOM\Platform\Internal\ASCOM.Internal.GACInstall.exe");
            }
            catch (Exception ex)
            {
                TL.LogMessage("PlatformFiles", "Exception: " + ex.ToString());
            ...
            try
            {
                fileList.Add(@"$COMMONFILES$\ASCOM\Platform\Internal\MigrateProfile.exe");
                TL.LogMessage("PlatformFiles", @"Added file: $COMMONFILES$\ASCOM\Platform\Internal\MigrateProfile.exe");
            }
            catch (Exception ex)
            {
                TL.LogMessage("PlatformFiles", "Exception: " + ex.ToString());
            ...
            try
            {
                fileList.Add(@"$COMMONFILES$\ASCOM\Platform\Internal\RegTlb.exe");
                TL.LogMessage("PlatformFiles", @"Added file: $COMMONFILES$\ASCOM\Platform\Internal\RegTlb.exe");
            }
            catch (Exception ex)
            {
                TL.LogMessage("PlatformFiles", "Exception: " + ex.ToString());
            ...
            try
            {
                fileList.Add(@"$COMMONFILES$\ASCOM\Platform\Internet.ico");
                TL.LogMessage("PlatformFiles", @"Added file: $COMMONFILES$\ASCOM\Platform\Internet.ico");
            }
            catch (Exception ex)
            {
                TL.LogMessage("PlatformFiles", "Exception: " + ex.ToString());
            ...
            try
            {
                fileList.Add(@"$COMMONFILES$\ASCOM\Platform\v5.5\ASCOM.Astrometry.pdb");
                TL.LogMessage("PlatformFiles", @"Added file: $COMMONFILES$\ASCOM\Platform\v5.5\ASCOM.Astrometry.pdb");
            }
            catch (Exception ex)
            {
                TL.LogMessage("PlatformFiles", "Exception: " + ex.ToString());
            ...
            try
            {
                fileList.Add(@"$COMMONFILES$\ASCOM\Platform\v5.5\ASCOM.Attributes.pdb");
                TL.LogMessage("PlatformFiles", @"Added file: $COMMONFILES$\ASCOM\Platform\v5.5\ASCOM.Attributes.pdb");
            }
            catch (Exception ex)
            {
                TL.LogMessage("PlatformFiles", "Exception: " + ex.ToString());
            ...
            try
            {
                fileList.Add(@"$COMMONFILES$\ASCOM\Platform\v5.5\ASCOM.DriverAccess.pdb");
                TL.LogMessage("PlatformFiles", @"Added file: $COMMONFILES$\ASCOM\Platform\v5.5\ASCOM.DriverAccess.pdb");
            }
            catch (Exception ex)
            {
                TL.LogMessage("PlatformFiles", "Exception: " + ex.ToString());
            ...
            try
            {
                fileList.Add(@"$COMMONFILES$\ASCOM\Platform\v5.5\ASCOM.Utilities.pdb");
                TL.LogMessage("PlatformFiles", @"Added file: $COMMONFILES$\ASCOM\Platform\v5.5\ASCOM.Utilities.pdb");
            }
            catch (Exception ex)
            {
                TL.LogMessage("PlatformFiles", "Exception: " + ex.ToString());
            ...
            try
            {
                fileList.Add(@"$COMMONFILES$\ASCOM\Platform\v5.5\AstrometryPolicy.xml");
                TL.LogMessage("PlatformFiles", @"Added file: $COMMONFILES$\ASCOM\Platform\v5.5\AstrometryPolicy.xml");
            }
            catch (Exception ex)
            {
                TL.LogMessage("PlatformFiles", "Exception: " + ex.ToString());
            ...
            try
            {
                fileList.Add(@"$COMMONFILES$\ASCOM\Platform\v5.5\DriverAccess.config");
                TL.LogMessage("PlatformFiles", @"Added file: $COMMONFILES$\ASCOM\Platform\v5.5\DriverAccess.config");
            }
            catch (Exception ex)
            {
                TL.LogMessage("PlatformFiles", "Exception: " + ex.ToString());
            ...
            try
            {
                fileList.Add(@"$COMMONFILES$\ASCOM\Platform\v5.5\policy.1.0.ASCOM.DriverAccess.dll");
                TL.LogMessage("PlatformFiles", @"Added file: $COMMONFILES$\ASCOM\Platform\v5.5\policy.1.0.ASCOM.DriverAccess.dll");
            }
            catch (Exception ex)
            {
                TL.LogMessage("PlatformFiles", "Exception: " + ex.ToString());
            ...
            try
            {
                fileList.Add(@"$COMMONFILES$\ASCOM\Platform\v5.5\policy.5.5.ASCOM.Astrometry.dll");
                TL.LogMessage("PlatformFiles", @"Added file: $COMMONFILES$\ASCOM\Platform\v5.5\policy.5.5.ASCOM.Astrometry.dll");
            }
            catch (Exception ex)
            {
                TL.LogMessage("PlatformFiles", "Exception: " + ex.ToString());
            ...
            try
            {
                fileList.Add(@"$COMMONFILES$\ASCOM\Platform\v5.5\policy.5.5.ASCOM.Utilities.dll");
                TL.LogMessage("PlatformFiles", @"Added file: $COMMONFILES$\ASCOM\Platform\v5.5\policy.5.5.ASCOM.Utilities.dll");
            }
            catch (Exception ex)
            {
                TL.LogMessage("PlatformFiles", "Exception: " + ex.ToString());
            ...
            try
            {
                fileList.Add(@"$COMMONFILES$\ASCOM\Platform\v5.5\UtilitiesPolicy.xml");
                TL.LogMessage("PlatformFiles", @"Added file: $COMMONFILES$\ASCOM\Platform\v5.5\UtilitiesPolicy.xml");
            }
            catch (Exception ex)
            {
                TL.LogMessage("PlatformFiles", "Exception: " + ex.ToString());
            ...
            try
            {
                fileList.Add(@"$COMMONFILES$\ASCOM\Platform\v6.0\ExceptionsPolicy.xml");
                TL.LogMessage("PlatformFiles", @"Added file: $COMMONFILES$\ASCOM\Platform\v6.0\ExceptionsPolicy.xml");
            }
            catch (Exception ex)
            {
                TL.LogMessage("PlatformFiles", "Exception: " + ex.ToString());
            ...
            try
            {
                fileList.Add(@"$COMMONFILES$\ASCOM\Platform\v6.0\policy.1.0.ASCOM.Exceptions.dll");
                TL.LogMessage("PlatformFiles", @"Added file: $COMMONFILES$\ASCOM\Platform\v6.0\policy.1.0.ASCOM.Exceptions.dll");
            }
            catch (Exception ex)
            {
                TL.LogMessage("PlatformFiles", "Exception: " + ex.ToString());
            ...
            try
            {
                fileList.Add(@"$COMMONFILES$\ASCOM\Platform\v6.0\policy.1.1.ASCOM.Exceptions.dll");
                TL.LogMessage("PlatformFiles", @"Added file: $COMMONFILES$\ASCOM\Platform\v6.0\policy.1.1.ASCOM.Exceptions.dll");
            }
            catch (Exception ex)
            {
                TL.LogMessage("PlatformFiles", "Exception: " + ex.ToString());
            ...
            try
            {
                fileList.Add(@"$COMMONFILES$\ASCOM\Platform\v6.1\ASCOM.Utilities.Video.dll");
                TL.LogMessage("PlatformFiles", @"Added file: $COMMONFILES$\ASCOM\Platform\v6.1\ASCOM.Utilities.Video.dll");
            }
            catch (Exception ex)
            {
                TL.LogMessage("PlatformFiles", "Exception: " + ex.ToString());
            ...
            try
            {
                fileList.Add(@"$COMMONFILES$\ASCOM\Platform\v6\ASCOM.Astrometry.dll");
                TL.LogMessage("PlatformFiles", @"Added file: $COMMONFILES$\ASCOM\Platform\v6\ASCOM.Astrometry.dll");
            }
            catch (Exception ex)
            {
                TL.LogMessage("PlatformFiles", "Exception: " + ex.ToString());
            ...
            try
            {
                fileList.Add(@"$COMMONFILES$\ASCOM\Platform\v6\ASCOM.Exceptions.dll");
                TL.LogMessage("PlatformFiles", @"Added file: $COMMONFILES$\ASCOM\Platform\v6\ASCOM.Exceptions.dll");
            }
            catch (Exception ex)
            {
                TL.LogMessage("PlatformFiles", "Exception: " + ex.ToString());
            ...
            try
            {
                fileList.Add(@"$COMMONFILES$\ASCOM\Platform\v6\ASCOM.Utilities.dll");
                TL.LogMessage("PlatformFiles", @"Added file: $COMMONFILES$\ASCOM\Platform\v6\ASCOM.Utilities.dll");
            }
            catch (Exception ex)
            {
                TL.LogMessage("PlatformFiles", "Exception: " + ex.ToString());
            ...
            try
            {
                fileList.Add(@"$COMMONFILES$\ASCOM\Rotator\ASCOM.RotatorSimulator\ASCOM.RotatorSimulator.exe");
                TL.LogMessage("PlatformFiles", @"Added file: $COMMONFILES$\ASCOM\Rotator\ASCOM.RotatorSimulator\ASCOM.RotatorSimulator.exe");
            }
            catch (Exception ex)
            {
                TL.LogMessage("PlatformFiles", "Exception: " + ex.ToString());
            ...
            try
            {
                fileList.Add(@"$COMMONFILES$\ASCOM\Rotator\ASCOM.RotatorSimulator\ASCOM.RotatorSimulator.pdb");
                TL.LogMessage("PlatformFiles", @"Added file: $COMMONFILES$\ASCOM\Rotator\ASCOM.RotatorSimulator\ASCOM.RotatorSimulator.pdb");
            }
            catch (Exception ex)
            {
                TL.LogMessage("PlatformFiles", "Exception: " + ex.ToString());
            ...
            try
            {
                fileList.Add(@"$COMMONFILES$\ASCOM\Rotator\ASCOM.RotatorSimulator\ASCOM.Simulator.Rotator.dll");
                TL.LogMessage("PlatformFiles", @"Added file: $COMMONFILES$\ASCOM\Rotator\ASCOM.RotatorSimulator\ASCOM.Simulator.Rotator.dll");
            }
            catch (Exception ex)
            {
                TL.LogMessage("PlatformFiles", "Exception: " + ex.ToString());
            ...
            try
            {
                fileList.Add(@"$COMMONFILES$\ASCOM\Rotator\ASCOM.RotatorSimulator\ASCOM.Simulator.Rotator.pdb");
                TL.LogMessage("PlatformFiles", @"Added file: $COMMONFILES$\ASCOM\Rotator\ASCOM.RotatorSimulator\ASCOM.Simulator.Rotator.pdb");
            }
            catch (Exception ex)
            {
                TL.LogMessage("PlatformFiles", "Exception: " + ex.ToString());
            ...
            try
            {
                fileList.Add(@"$COMMONFILES$\ASCOM\SafetyMonitor\ASCOM.Simulator.SafetyMonitor\ASCOM.Simulator.SafetyMonitor.dll");
                TL.LogMessage("PlatformFiles", @"Added file: $COMMONFILES$\ASCOM\SafetyMonitor\ASCOM.Simulator.SafetyMonitor\ASCOM.Simulator.SafetyMonitor.dll");
            }
            catch (Exception ex)
            {
                TL.LogMessage("PlatformFiles", "Exception: " + ex.ToString());
            ...
            try
            {
                fileList.Add(@"$COMMONFILES$\ASCOM\SafetyMonitor\ASCOM.Simulator.SafetyMonitor\ASCOM.Simulator.SafetyMonitor.pdb");
                TL.LogMessage("PlatformFiles", @"Added file: $COMMONFILES$\ASCOM\SafetyMonitor\ASCOM.Simulator.SafetyMonitor\ASCOM.Simulator.SafetyMonitor.pdb");
            }
            catch (Exception ex)
            {
                TL.LogMessage("PlatformFiles", "Exception: " + ex.ToString());
            ...
            try
            {
                fileList.Add(@"$COMMONFILES$\ASCOM\ShowPlatformVersion.vbs");
                TL.LogMessage("PlatformFiles", @"Added file: $COMMONFILES$\ASCOM\ShowPlatformVersion.vbs");
            }
            catch (Exception ex)
            {
                TL.LogMessage("PlatformFiles", "Exception: " + ex.ToString());
            ...
            try
            {
                fileList.Add(@"$COMMONFILES$\ASCOM\Switch\Switch V2\ASCOM.Simulator.Server.exe");
                TL.LogMessage("PlatformFiles", @"Added file: $COMMONFILES$\ASCOM\Switch\Switch V2\ASCOM.Simulator.Server.exe");
            }
            catch (Exception ex)
            {
                TL.LogMessage("PlatformFiles", "Exception: " + ex.ToString());
            ...
            try
            {
                fileList.Add(@"$COMMONFILES$\ASCOM\Switch\Switch V2\ASCOM.Simulator.Server.exe.config");
                TL.LogMessage("PlatformFiles", @"Added file: $COMMONFILES$\ASCOM\Switch\Switch V2\ASCOM.Simulator.Server.exe.config");
            }
            catch (Exception ex)
            {
                TL.LogMessage("PlatformFiles", "Exception: " + ex.ToString());
            ...
            try
            {
                fileList.Add(@"$COMMONFILES$\ASCOM\Switch\Switch V2\ASCOM.Simulator.Server.pdb");
                TL.LogMessage("PlatformFiles", @"Added file: $COMMONFILES$\ASCOM\Switch\Switch V2\ASCOM.Simulator.Server.pdb");
            }
            catch (Exception ex)
            {
                TL.LogMessage("PlatformFiles", "Exception: " + ex.ToString());
            ...
            try
            {
                fileList.Add(@"$COMMONFILES$\ASCOM\Switch\Switch V2\ASCOM.Simulator.Switch.dll");
                TL.LogMessage("PlatformFiles", @"Added file: $COMMONFILES$\ASCOM\Switch\Switch V2\ASCOM.Simulator.Switch.dll");
            }
            catch (Exception ex)
            {
                TL.LogMessage("PlatformFiles", "Exception: " + ex.ToString());
            ...
            try
            {
                fileList.Add(@"$COMMONFILES$\ASCOM\Switch\Switch V2\ASCOM.Simulator.Switch.dll.config");
                TL.LogMessage("PlatformFiles", @"Added file: $COMMONFILES$\ASCOM\Switch\Switch V2\ASCOM.Simulator.Switch.dll.config");
            }
            catch (Exception ex)
            {
                TL.LogMessage("PlatformFiles", "Exception: " + ex.ToString());
            ...
            try
            {
                fileList.Add(@"$COMMONFILES$\ASCOM\Switch\Switch V2\ASCOM.Simulator.Switch.pdb");
                TL.LogMessage("PlatformFiles", @"Added file: $COMMONFILES$\ASCOM\Switch\Switch V2\ASCOM.Simulator.Switch.pdb");
            }
            catch (Exception ex)
            {
                TL.LogMessage("PlatformFiles", "Exception: " + ex.ToString());
            ...
            try
            {
                fileList.Add(@"$COMMONFILES$\ASCOM\Switch\SwitchSim.exe");
                TL.LogMessage("PlatformFiles", @"Added file: $COMMONFILES$\ASCOM\Switch\SwitchSim.exe");
            }
            catch (Exception ex)
            {
                TL.LogMessage("PlatformFiles", "Exception: " + ex.ToString());
            ...
            try
            {
                fileList.Add(@"$COMMONFILES$\ASCOM\Telescope\ASCOM.TelescopeSimulator\ASCOM.Simulator.Telescope.dll");
                TL.LogMessage("PlatformFiles", @"Added file: $COMMONFILES$\ASCOM\Telescope\ASCOM.TelescopeSimulator\ASCOM.Simulator.Telescope.dll");
            }
            catch (Exception ex)
            {
                TL.LogMessage("PlatformFiles", "Exception: " + ex.ToString());
            ...
            try
            {
                fileList.Add(@"$COMMONFILES$\ASCOM\Telescope\ASCOM.TelescopeSimulator\ASCOM.Simulator.Telescope.pdb");
                TL.LogMessage("PlatformFiles", @"Added file: $COMMONFILES$\ASCOM\Telescope\ASCOM.TelescopeSimulator\ASCOM.Simulator.Telescope.pdb");
            }
            catch (Exception ex)
            {
                TL.LogMessage("PlatformFiles", "Exception: " + ex.ToString());
            ...
            try
            {
                fileList.Add(@"$COMMONFILES$\ASCOM\Telescope\ASCOM.TelescopeSimulator\ASCOM.TelescopeSimulator.exe");
                TL.LogMessage("PlatformFiles", @"Added file: $COMMONFILES$\ASCOM\Telescope\ASCOM.TelescopeSimulator\ASCOM.TelescopeSimulator.exe");
            }
            catch (Exception ex)
            {
                TL.LogMessage("PlatformFiles", "Exception: " + ex.ToString());
            ...
            try
            {
                fileList.Add(@"$COMMONFILES$\ASCOM\Telescope\ASCOM.TelescopeSimulator\ASCOM.TelescopeSimulator.pdb");
                TL.LogMessage("PlatformFiles", @"Added file: $COMMONFILES$\ASCOM\Telescope\ASCOM.TelescopeSimulator\ASCOM.TelescopeSimulator.pdb");
            }
            catch (Exception ex)
            {
                TL.LogMessage("PlatformFiles", "Exception: " + ex.ToString());
            ...
            try
            {
                fileList.Add(@"$COMMONFILES$\ASCOM\Telescope\Astro32.dll");
                TL.LogMessage("PlatformFiles", @"Added file: $COMMONFILES$\ASCOM\Telescope\Astro32.dll");
            }
            catch (Exception ex)
            {
                TL.LogMessage("PlatformFiles", "Exception: " + ex.ToString());
            ...
            try
            {
                fileList.Add(@"$COMMONFILES$\ASCOM\Telescope\Hub.exe");
                TL.LogMessage("PlatformFiles", @"Added file: $COMMONFILES$\ASCOM\Telescope\Hub.exe");
            }
            catch (Exception ex)
            {
                TL.LogMessage("PlatformFiles", "Exception: " + ex.ToString());
            ...
            try
            {
                fileList.Add(@"$COMMONFILES$\ASCOM\Telescope\Pipe.exe");
                TL.LogMessage("PlatformFiles", @"Added file: $COMMONFILES$\ASCOM\Telescope\Pipe.exe");
            }
            catch (Exception ex)
            {
                TL.LogMessage("PlatformFiles", "Exception: " + ex.ToString());
            ...
            try
            {
                fileList.Add(@"$COMMONFILES$\ASCOM\Telescope\PipeHubHelp.htm");
                TL.LogMessage("PlatformFiles", @"Added file: $COMMONFILES$\ASCOM\Telescope\PipeHubHelp.htm");
            }
            catch (Exception ex)
            {
                TL.LogMessage("PlatformFiles", "Exception: " + ex.ToString());
            ...
            try
            {
                fileList.Add(@"$COMMONFILES$\ASCOM\Telescope\POTH.exe");
                TL.LogMessage("PlatformFiles", @"Added file: $COMMONFILES$\ASCOM\Telescope\POTH.exe");
            }
            catch (Exception ex)
            {
                TL.LogMessage("PlatformFiles", "Exception: " + ex.ToString());
            ...
            try
            {
                fileList.Add(@"$COMMONFILES$\ASCOM\Telescope\POTHHelp.htm");
                TL.LogMessage("PlatformFiles", @"Added file: $COMMONFILES$\ASCOM\Telescope\POTHHelp.htm");
            }
            catch (Exception ex)
            {
                TL.LogMessage("PlatformFiles", "Exception: " + ex.ToString());
            ...
            try
            {
                fileList.Add(@"$COMMONFILES$\ASCOM\Telescope\ScopeSim.exe");
                TL.LogMessage("PlatformFiles", @"Added file: $COMMONFILES$\ASCOM\Telescope\ScopeSim.exe");
            }
            catch (Exception ex)
            {
                TL.LogMessage("PlatformFiles", "Exception: " + ex.ToString());
            ...
            try
            {
                fileList.Add(@"$COMMONFILES$\ASCOM\Telescope\ScopeSimHelp.htm");
                TL.LogMessage("PlatformFiles", @"Added file: $COMMONFILES$\ASCOM\Telescope\ScopeSimHelp.htm");
            }
            catch (Exception ex)
            {
                TL.LogMessage("PlatformFiles", "Exception: " + ex.ToString());
            ...
            try
            {
                fileList.Add(@"$COMMONFILES$\ASCOM\Video\ASCOM.Simulator.Video\ASCOM.Simulator.Video.dll");
                TL.LogMessage("PlatformFiles", @"Added file: $COMMONFILES$\ASCOM\Video\ASCOM.Simulator.Video\ASCOM.Simulator.Video.dll");
            }
            catch (Exception ex)
            {
                TL.LogMessage("PlatformFiles", "Exception: " + ex.ToString());
            ...
            try
            {
                fileList.Add(@"$COMMONFILES$\ASCOM\Video\ASCOM.Simulator.Video\ASCOM.Simulator.Video.pdb");
                TL.LogMessage("PlatformFiles", @"Added file: $COMMONFILES$\ASCOM\Video\ASCOM.Simulator.Video\ASCOM.Simulator.Video.pdb");
            }
            catch (Exception ex)
            {
                TL.LogMessage("PlatformFiles", "Exception: " + ex.ToString());
            ...
            try
            {
                fileList.Add(@"$COMMONFILES$\ASCOM\Video\ASCOM.Simulator.Video\DirectShowLib-2005.dll");
                TL.LogMessage("PlatformFiles", @"Added file: $COMMONFILES$\ASCOM\Video\ASCOM.Simulator.Video\DirectShowLib-2005.dll");
            }
            catch (Exception ex)
            {
                TL.LogMessage("PlatformFiles", "Exception: " + ex.ToString());
            ...
            try
            {
                fileList.Add(@"$COMMONFILES$\ASCOM\Video\ASCOM.Simulator.Video\Resources\simulator.pix");
                TL.LogMessage("PlatformFiles", @"Added file: $COMMONFILES$\ASCOM\Video\ASCOM.Simulator.Video\Resources\simulator.pix");
            }
            catch (Exception ex)
            {
                TL.LogMessage("PlatformFiles", "Exception: " + ex.ToString());
            ...
            try
            {
                fileList.Add(@"$COMMONFILES$\ASCOM\VideoUtilities\ASCOM.NativeVideo32.dll");
                TL.LogMessage("PlatformFiles", @"Added file: $COMMONFILES$\ASCOM\VideoUtilities\ASCOM.NativeVideo32.dll");
            }
            catch (Exception ex)
            {
                TL.LogMessage("PlatformFiles", "Exception: " + ex.ToString());
            ...
            try
            {
                fileList.Add(@"$COMMONFILES$\ASCOM\VideoUtilities\ASCOM.NativeVideo32.pdb");
                TL.LogMessage("PlatformFiles", @"Added file: $COMMONFILES$\ASCOM\VideoUtilities\ASCOM.NativeVideo32.pdb");
            }
            catch (Exception ex)
            {
                TL.LogMessage("PlatformFiles", "Exception: " + ex.ToString());
            ...
            try
            {
                fileList.Add(@"$COMMONFILES$\ASCOM\VideoUtilities\ASCOM.NativeVideo64.dll");
                TL.LogMessage("PlatformFiles", @"Added file: $COMMONFILES$\ASCOM\VideoUtilities\ASCOM.NativeVideo64.dll");
            }
            catch (Exception ex)
            {
                TL.LogMessage("PlatformFiles", "Exception: " + ex.ToString());
            ...
            try
            {
                fileList.Add(@"$COMMONFILES$\ASCOM\VideoUtilities\ASCOM.NativeVideo64.pdb");
                TL.LogMessage("PlatformFiles", @"Added file: $COMMONFILES$\ASCOM\VideoUtilities\ASCOM.NativeVideo64.pdb");
            }
            catch (Exception ex)
            {
                TL.LogMessage("PlatformFiles", "Exception: " + ex.ToString());
            ...
            try
            {
                fileList.Add(@"$COMMONFILES64$ASCOM\.net\ASCOM.DriverAccess.dll");
                TL.LogMessage("PlatformFiles", @"Added file: $COMMONFILES64$ASCOM\.net\ASCOM.DriverAccess.dll");
            }
            catch (Exception ex)
            {
                TL.LogMessage("PlatformFiles", "Exception: " + ex.ToString());
            ...
            try
            {
                fileList.Add(@"$COMMONFILES64$ASCOM\.net\ASCOM.Utilities.dll");
                TL.LogMessage("PlatformFiles", @"Added file: $COMMONFILES64$ASCOM\.net\ASCOM.Utilities.dll");
            }
            catch (Exception ex)
            {
                TL.LogMessage("PlatformFiles", "Exception: " + ex.ToString());
            ...
            try
            {
                fileList.Add(@"$COMMONFILES64$ASCOM\.net\These files are not in use - ReadMe.txt");
                TL.LogMessage("PlatformFiles", @"Added file: $COMMONFILES64$ASCOM\.net\These files are not in use - ReadMe.txt");
            }
            catch (Exception ex)
            {
                TL.LogMessage("PlatformFiles", "Exception: " + ex.ToString());
            ...
            try
            {
                fileList.Add(@"$TARGETDIR$\Docs\ASCOM_Users_Guide.pdf");
                TL.LogMessage("PlatformFiles", @"Added file: $TARGETDIR$\Docs\ASCOM_Users_Guide.pdf");
            }
            catch (Exception ex)
            {
                TL.LogMessage("PlatformFiles", "Exception: " + ex.ToString());
            ...
            try
            {
                fileList.Add(@"$TARGETDIR$\Docs\Bug72T-sm.jpg");
                TL.LogMessage("PlatformFiles", @"Added file: $TARGETDIR$\Docs\Bug72T-sm.jpg");
            }
            catch (Exception ex)
            {
                TL.LogMessage("PlatformFiles", "Exception: " + ex.ToString());
            ...
            try
            {
                fileList.Add(@"$TARGETDIR$\Docs\Compatible Software (web).url");
                TL.LogMessage("PlatformFiles", @"Added file: $TARGETDIR$\Docs\Compatible Software (web).url");
            }
            catch (Exception ex)
            {
                TL.LogMessage("PlatformFiles", "Exception: " + ex.ToString());
            ...
            try
            {
                fileList.Add(@"$TARGETDIR$\Docs\Drivers and Downloads (web).url");
                TL.LogMessage("PlatformFiles", @"Added file: $TARGETDIR$\Docs\Drivers and Downloads (web).url");
            }
            catch (Exception ex)
            {
                TL.LogMessage("PlatformFiles", "Exception: " + ex.ToString());
            ...
            try
            {
                fileList.Add(@"$TARGETDIR$\Docs\PlatformHelp.chm");
                TL.LogMessage("PlatformFiles", @"Added file: $TARGETDIR$\Docs\PlatformHelp.chm");
            }
            catch (Exception ex)
            {
                TL.LogMessage("PlatformFiles", "Exception: " + ex.ToString());
            ...
            try
            {
                fileList.Add(@"$TARGETDIR$\Docs\Support (web).url");
                TL.LogMessage("PlatformFiles", @"Added file: $TARGETDIR$\Docs\Support (web).url");
            }
            catch (Exception ex)
            {
                TL.LogMessage("PlatformFiles", "Exception: " + ex.ToString());
            ...
            try
            {
                fileList.Add(@"$TARGETDIR$\Docs\Supported Devices (web).url");
                TL.LogMessage("PlatformFiles", @"Added file: $TARGETDIR$\Docs\Supported Devices (web).url");
            }
            catch (Exception ex)
            {
                TL.LogMessage("PlatformFiles", "Exception: " + ex.ToString());
            ...
            try
            {
                fileList.Add(@"$TARGETDIR$\Tools\ASCOM Diagnostics.exe");
                TL.LogMessage("PlatformFiles", @"Added file: $TARGETDIR$\Tools\ASCOM Diagnostics.exe");
            }
            catch (Exception ex)
            {
                TL.LogMessage("PlatformFiles", "Exception: " + ex.ToString());
            ...
            try
            {
                fileList.Add(@"$TARGETDIR$\Tools\ASCOM Diagnostics.pdb");
                TL.LogMessage("PlatformFiles", @"Added file: $TARGETDIR$\Tools\ASCOM Diagnostics.pdb");
            }
            catch (Exception ex)
            {
                TL.LogMessage("PlatformFiles", "Exception: " + ex.ToString());
            ...
            try
            {
                fileList.Add(@"$TARGETDIR$\Tools\ASCOM Diagnostics.xml");
                TL.LogMessage("PlatformFiles", @"Added file: $TARGETDIR$\Tools\ASCOM Diagnostics.xml");
            }
            catch (Exception ex)
            {
                TL.LogMessage("PlatformFiles", "Exception: " + ex.ToString());
            ...
            try
            {
                fileList.Add(@"$TARGETDIR$\Tools\Ceres.chby");
                TL.LogMessage("PlatformFiles", @"Added file: $TARGETDIR$\Tools\Ceres.chby");
            }
            catch (Exception ex)
            {
                TL.LogMessage("PlatformFiles", "Exception: " + ex.ToString());
            ...
            try
            {
                fileList.Add(@"$TARGETDIR$\Tools\CheckForUpdates.js");
                TL.LogMessage("PlatformFiles", @"Added file: $TARGETDIR$\Tools\CheckForUpdates.js");
            }
            catch (Exception ex)
            {
                TL.LogMessage("PlatformFiles", "Exception: " + ex.ToString());
            ...
            try
            {
                fileList.Add(@"$TARGETDIR$\Tools\ProfileExplorer.exe");
                TL.LogMessage("PlatformFiles", @"Added file: $TARGETDIR$\Tools\ProfileExplorer.exe");
            }
            catch (Exception ex)
            {
                TL.LogMessage("PlatformFiles", "Exception: " + ex.ToString());
            ...
            try
            {
                fileList.Add(@"$TARGETDIR$\Tools\ProfileExplorer.pdb");
                TL.LogMessage("PlatformFiles", @"Added file: $TARGETDIR$\Tools\ProfileExplorer.pdb");
            }
            catch (Exception ex)
            {
                TL.LogMessage("PlatformFiles", "Exception: " + ex.ToString());
            ...
            try
            {
                fileList.Add(@"$TARGETDIR$\Tools\ProfileExplorer.xml");
                TL.LogMessage("PlatformFiles", @"Added file: $TARGETDIR$\Tools\ProfileExplorer.xml");
            }
            catch (Exception ex)
            {
                TL.LogMessage("PlatformFiles", "Exception: " + ex.ToString());
        ...
        public static SortedSet<string> DeveloperFiles(TraceLogger TL)
        {
            SortedSet<string> fileList;
            fileList = new SortedSet<string>();
            try
            {
                fileList.Add(@"$TARGETDIR$\Components\Platform5\ASCOM.Exceptions.dll");
                TL.LogMessage("DeveloperFiles", @"Added file: $TARGETDIR$\Components\Platform5\ASCOM.Exceptions.dll");
            }
            catch (Exception ex)
            {
                TL.LogMessage("PlatformFiles", "Exception: " + ex.ToString());
            ...
            try
            {
                fileList.Add(@"$TARGETDIR$\Components\Platform5\ASCOM.Exceptions.xml");
                TL.LogMessage("DeveloperFiles", @"Added file: $TARGETDIR$\Components\Platform5\ASCOM.Exceptions.xml");
            }
            catch (Exception ex)
            {
                TL.LogMessage("PlatformFiles", "Exception: " + ex.ToString());
            ...
            try
            {
                fileList.Add(@"$TARGETDIR$\Components\Platform55\\ASCOM.Astrometry.dll");
                TL.LogMessage("DeveloperFiles", @"Added file: $TARGETDIR$\Components\Platform55\\ASCOM.Astrometry.dll");
            }
            catch (Exception ex)
            {
                TL.LogMessage("PlatformFiles", "Exception: " + ex.ToString());
            ...
            try
            {
                fileList.Add(@"$TARGETDIR$\Components\Platform55\\ASCOM.Astrometry.xml");
                TL.LogMessage("DeveloperFiles", @"Added file: $TARGETDIR$\Components\Platform55\\ASCOM.Astrometry.xml");
            }
            catch (Exception ex)
            {
                TL.LogMessage("PlatformFiles", "Exception: " + ex.ToString());
            ...
            try
            {
                fileList.Add(@"$TARGETDIR$\Components\Platform55\\ASCOM.Attributes.dll");
                TL.LogMessage("DeveloperFiles", @"Added file: $TARGETDIR$\Components\Platform55\\ASCOM.Attributes.dll");
            }
            catch (Exception ex)
            {
                TL.LogMessage("PlatformFiles", "Exception: " + ex.ToString());
            ...
            try
            {
                fileList.Add(@"$TARGETDIR$\Components\Platform55\\ASCOM.Attributes.xml");
                TL.LogMessage("DeveloperFiles", @"Added file: $TARGETDIR$\Components\Platform55\\ASCOM.Attributes.xml");
            }
            catch (Exception ex)
            {
                TL.LogMessage("PlatformFiles", "Exception: " + ex.ToString());
            ...
            try
            {
                fileList.Add(@"$TARGETDIR$\Components\Platform55\\ASCOM.DriverAccess.dll");
                TL.LogMessage("DeveloperFiles", @"Added file: $TARGETDIR$\Components\Platform55\\ASCOM.DriverAccess.dll");
            }
            catch (Exception ex)
            {
                TL.LogMessage("PlatformFiles", "Exception: " + ex.ToString());
            ...
            try
            {
                fileList.Add(@"$TARGETDIR$\Components\Platform55\\ASCOM.DriverAccess.xml");
                TL.LogMessage("DeveloperFiles", @"Added file: $TARGETDIR$\Components\Platform55\\ASCOM.DriverAccess.xml");
            }
            catch (Exception ex)
            {
                TL.LogMessage("PlatformFiles", "Exception: " + ex.ToString());
            ...
            try
            {
                fileList.Add(@"$TARGETDIR$\Components\Platform55\\ASCOM.Exceptions.dll");
                TL.LogMessage("DeveloperFiles", @"Added file: $TARGETDIR$\Components\Platform55\\ASCOM.Exceptions.dll");
            }
            catch (Exception ex)
            {
                TL.LogMessage("PlatformFiles", "Exception: " + ex.ToString());
            ...
            try
            {
                fileList.Add(@"$TARGETDIR$\Components\Platform55\\ASCOM.Exceptions.xml");
                TL.LogMessage("DeveloperFiles", @"Added file: $TARGETDIR$\Components\Platform55\\ASCOM.Exceptions.xml");
            }
            catch (Exception ex)
            {
                TL.LogMessage("PlatformFiles", "Exception: " + ex.ToString());
            ...
            try
            {
                fileList.Add(@"$TARGETDIR$\Components\Platform55\\ASCOM.Utilities.dll");
                TL.LogMessage("DeveloperFiles", @"Added file: $TARGETDIR$\Components\Platform55\\ASCOM.Utilities.dll");
            }
            catch (Exception ex)
            {
                TL.LogMessage("PlatformFiles", "Exception: " + ex.ToString());
            ...
            try
            {
                fileList.Add(@"$TARGETDIR$\Components\Platform55\\ASCOM.Utilities.xml");
                TL.LogMessage("DeveloperFiles", @"Added file: $TARGETDIR$\Components\Platform55\\ASCOM.Utilities.xml");
            }
            catch (Exception ex)
            {
                TL.LogMessage("PlatformFiles", "Exception: " + ex.ToString());
            ...
            try
            {
                fileList.Add(@"$TARGETDIR$\Components\Platform6\ASCOM.Astrometry.dll");
                TL.LogMessage("DeveloperFiles", @"Added file: $TARGETDIR$\Components\Platform6\ASCOM.Astrometry.dll");
            }
            catch (Exception ex)
            {
                TL.LogMessage("PlatformFiles", "Exception: " + ex.ToString());
            ...
            try
            {
                fileList.Add(@"$TARGETDIR$\Components\Platform6\ASCOM.Astrometry.xml");
                TL.LogMessage("DeveloperFiles", @"Added file: $TARGETDIR$\Components\Platform6\ASCOM.Astrometry.xml");
            }
            catch (Exception ex)
            {
                TL.LogMessage("PlatformFiles", "Exception: " + ex.ToString());
            ...
            try
            {
                fileList.Add(@"$TARGETDIR$\Components\Platform6\ASCOM.Attributes.dll");
                TL.LogMessage("DeveloperFiles", @"Added file: $TARGETDIR$\Components\Platform6\ASCOM.Attributes.dll");
            }
            catch (Exception ex)
            {
                TL.LogMessage("PlatformFiles", "Exception: " + ex.ToString());
            ...
            try
            {
                fileList.Add(@"$TARGETDIR$\Components\Platform6\ASCOM.Attributes.xml");
                TL.LogMessage("DeveloperFiles", @"Added file: $TARGETDIR$\Components\Platform6\ASCOM.Attributes.xml");
            }
            catch (Exception ex)
            {
                TL.LogMessage("PlatformFiles", "Exception: " + ex.ToString());
            ...
            try
            {
                fileList.Add(@"$TARGETDIR$\Components\Platform6\ASCOM.Controls.dll");
                TL.LogMessage("DeveloperFiles", @"Added file: $TARGETDIR$\Components\Platform6\ASCOM.Controls.dll");
            }
            catch (Exception ex)
            {
                TL.LogMessage("PlatformFiles", "Exception: " + ex.ToString());
            ...
            try
            {
                fileList.Add(@"$TARGETDIR$\Components\Platform6\ASCOM.Controls.xml");
                TL.LogMessage("DeveloperFiles", @"Added file: $TARGETDIR$\Components\Platform6\ASCOM.Controls.xml");
            }
            catch (Exception ex)
            {
                TL.LogMessage("PlatformFiles", "Exception: " + ex.ToString());
            ...
            try
            {
                fileList.Add(@"$TARGETDIR$\Components\Platform6\ASCOM.DeviceInterfaces.dll");
                TL.LogMessage("DeveloperFiles", @"Added file: $TARGETDIR$\Components\Platform6\ASCOM.DeviceInterfaces.dll");
            }
            catch (Exception ex)
            {
                TL.LogMessage("PlatformFiles", "Exception: " + ex.ToString());
            ...
            try
            {
                fileList.Add(@"$TARGETDIR$\Components\Platform6\ASCOM.DeviceInterfaces.xml");
                TL.LogMessage("DeveloperFiles", @"Added file: $TARGETDIR$\Components\Platform6\ASCOM.DeviceInterfaces.xml");
            }
            catch (Exception ex)
            {
                TL.LogMessage("PlatformFiles", "Exception: " + ex.ToString());
            ...
            try
            {
                fileList.Add(@"$TARGETDIR$\Components\Platform6\ASCOM.DriverAccess.dll");
                TL.LogMessage("DeveloperFiles", @"Added file: $TARGETDIR$\Components\Platform6\ASCOM.DriverAccess.dll");
            }
            catch (Exception ex)
            {
                TL.LogMessage("PlatformFiles", "Exception: " + ex.ToString());
            ...
            try
            {
                fileList.Add(@"$TARGETDIR$\Components\Platform6\ASCOM.DriverAccess.xml");
                TL.LogMessage("DeveloperFiles", @"Added file: $TARGETDIR$\Components\Platform6\ASCOM.DriverAccess.xml");
            }
            catch (Exception ex)
            {
                TL.LogMessage("PlatformFiles", "Exception: " + ex.ToString());
            ...
            try
            {
                fileList.Add(@"$TARGETDIR$\Components\Platform6\ASCOM.Exceptions.dll");
                TL.LogMessage("DeveloperFiles", @"Added file: $TARGETDIR$\Components\Platform6\ASCOM.Exceptions.dll");
            }
            catch (Exception ex)
            {
                TL.LogMessage("PlatformFiles", "Exception: " + ex.ToString());
            ...
            try
            {
                fileList.Add(@"$TARGETDIR$\Components\Platform6\ASCOM.Exceptions.xml");
                TL.LogMessage("DeveloperFiles", @"Added file: $TARGETDIR$\Components\Platform6\ASCOM.Exceptions.xml");
            }
            catch (Exception ex)
            {
                TL.LogMessage("PlatformFiles", "Exception: " + ex.ToString());
            ...
            try
            {
                fileList.Add(@"$TARGETDIR$\Components\Platform6\ASCOM.Internal.Extensions.dll");
                TL.LogMessage("DeveloperFiles", @"Added file: $TARGETDIR$\Components\Platform6\ASCOM.Internal.Extensions.dll");
            }
            catch (Exception ex)
            {
                TL.LogMessage("PlatformFiles", "Exception: " + ex.ToString());
            ...
            try
            {
                fileList.Add(@"$TARGETDIR$\Components\Platform6\ASCOM.Internal.Extensions.xml");
                TL.LogMessage("DeveloperFiles", @"Added file: $TARGETDIR$\Components\Platform6\ASCOM.Internal.Extensions.xml");
            }
            catch (Exception ex)
            {
                TL.LogMessage("PlatformFiles", "Exception: " + ex.ToString());
            ...
            try
            {
                fileList.Add(@"$TARGETDIR$\Components\Platform6\ASCOM.SettingsProvider.dll");
                TL.LogMessage("DeveloperFiles", @"Added file: $TARGETDIR$\Components\Platform6\ASCOM.SettingsProvider.dll");
            }
            catch (Exception ex)
            {
                TL.LogMessage("PlatformFiles", "Exception: " + ex.ToString());
            ...
            try
            {
                fileList.Add(@"$TARGETDIR$\Components\Platform6\ASCOM.SettingsProvider.xml");
                TL.LogMessage("DeveloperFiles", @"Added file: $TARGETDIR$\Components\Platform6\ASCOM.SettingsProvider.xml");
            }
            catch (Exception ex)
            {
                TL.LogMessage("PlatformFiles", "Exception: " + ex.ToString());
            ...
            try
            {
                fileList.Add(@"$TARGETDIR$\Components\Platform6\ASCOM.Utilities.dll");
                TL.LogMessage("DeveloperFiles", @"Added file: $TARGETDIR$\Components\Platform6\ASCOM.Utilities.dll");
            }
            catch (Exception ex)
            {
                TL.LogMessage("PlatformFiles", "Exception: " + ex.ToString());
            ...
            try
            {
                fileList.Add(@"$TARGETDIR$\Components\Platform6\ASCOM.Utilities.Video.dll");
                TL.LogMessage("DeveloperFiles", @"Added file: $TARGETDIR$\Components\Platform6\ASCOM.Utilities.Video.dll");
            }
            catch (Exception ex)
            {
                TL.LogMessage("PlatformFiles", "Exception: " + ex.ToString());
            ...
            try
            {
                fileList.Add(@"$TARGETDIR$\Components\Platform6\ASCOM.Utilities.xml");
                TL.LogMessage("DeveloperFiles", @"Added file: $TARGETDIR$\Components\Platform6\ASCOM.Utilities.xml");
            }
            catch (Exception ex)
            {
                TL.LogMessage("PlatformFiles", "Exception: " + ex.ToString());
            ...
            try
            {
                fileList.Add(@"$TARGETDIR$\Developer Documentation\Algorithms.pdf");
                TL.LogMessage("DeveloperFiles", @"Added file: $TARGETDIR$\Developer Documentation\Algorithms.pdf");
            }
            catch (Exception ex)
            {
                TL.LogMessage("PlatformFiles", "Exception: " + ex.ToString());
            ...
            try
            {
                fileList.Add(@"$TARGETDIR$\Developer Documentation\ASCOM Settings Provider.pdf");
                TL.LogMessage("DeveloperFiles", @"Added file: $TARGETDIR$\Developer Documentation\ASCOM Settings Provider.pdf");
            }
            catch (Exception ex)
            {
                TL.LogMessage("PlatformFiles", "Exception: " + ex.ToString());
            ...
            try
            {
                fileList.Add(@"$TARGETDIR$\Developer Documentation\ASCOM SideOfPier Behaviour.pdf");
                TL.LogMessage("DeveloperFiles", @"Added file: $TARGETDIR$\Developer Documentation\ASCOM SideOfPier Behaviour.pdf");
            }
            catch (Exception ex)
            {
                TL.LogMessage("PlatformFiles", "Exception: " + ex.ToString());
            ...
            try
            {
                fileList.Add(@"$TARGETDIR$\Developer Documentation\ASCOM Video Developers Documentation.pdf");
                TL.LogMessage("DeveloperFiles", @"Added file: $TARGETDIR$\Developer Documentation\ASCOM Video Developers Documentation.pdf");
            }
            catch (Exception ex)
            {
                TL.LogMessage("PlatformFiles", "Exception: " + ex.ToString());
            ...
            try
            {
                fileList.Add(@"$TARGETDIR$\Developer Documentation\Bug72T-sm.jpg");
                TL.LogMessage("DeveloperFiles", @"Added file: $TARGETDIR$\Developer Documentation\Bug72T-sm.jpg");
            }
            catch (Exception ex)
            {
                TL.LogMessage("PlatformFiles", "Exception: " + ex.ToString());
            ...
            try
            {
                fileList.Add(@"$TARGETDIR$\Developer Documentation\DriverInstallers.html");
                TL.LogMessage("DeveloperFiles", @"Added file: $TARGETDIR$\Developer Documentation\DriverInstallers.html");
            }
            catch (Exception ex)
            {
                TL.LogMessage("PlatformFiles", "Exception: " + ex.ToString());
            ...
            try
            {
                fileList.Add(@"$TARGETDIR$\Developer Documentation\Generating Multiple ASCOM Drivers.pdf");
                TL.LogMessage("DeveloperFiles", @"Added file: $TARGETDIR$\Developer Documentation\Generating Multiple ASCOM Drivers.pdf");
            }
            catch (Exception ex)
            {
                TL.LogMessage("PlatformFiles", "Exception: " + ex.ToString());
            ...
            try
            {
                fileList.Add(@"$TARGETDIR$\Developer Documentation\GuideToAstro32Migration.pdf");
                TL.LogMessage("DeveloperFiles", @"Added file: $TARGETDIR$\Developer Documentation\GuideToAstro32Migration.pdf");
            }
            catch (Exception ex)
            {
                TL.LogMessage("PlatformFiles", "Exception: " + ex.ToString());
            ...
            try
            {
                fileList.Add(@"$TARGETDIR$\Developer Documentation\Introduction to Developing ASCOM Drivers.pdf");
                TL.LogMessage("DeveloperFiles", @"Added file: $TARGETDIR$\Developer Documentation\Introduction to Developing ASCOM Drivers.pdf");
            }
            catch (Exception ex)
            {
                TL.LogMessage("PlatformFiles", "Exception: " + ex.ToString());
            ...
            try
            {
                fileList.Add(@"$TARGETDIR$\Developer Documentation\Making a Local Server based Driver.pdf");
                TL.LogMessage("DeveloperFiles", @"Added file: $TARGETDIR$\Developer Documentation\Making a Local Server based Driver.pdf");
            }
            catch (Exception ex)
            {
                TL.LogMessage("PlatformFiles", "Exception: " + ex.ToString());
            ...
            try
            {
                fileList.Add(@"$TARGETDIR$\Developer Documentation\NOVAS_C3.0_Guide.pdf");
                TL.LogMessage("DeveloperFiles", @"Added file: $TARGETDIR$\Developer Documentation\NOVAS_C3.0_Guide.pdf");
            }
            catch (Exception ex)
            {
                TL.LogMessage("PlatformFiles", "Exception: " + ex.ToString());
            ...
            try
            {
                fileList.Add(@"$TARGETDIR$\Developer Documentation\NOVAS_C3.1_Guide.pdf");
                TL.LogMessage("DeveloperFiles", @"Added file: $TARGETDIR$\Developer Documentation\NOVAS_C3.1_Guide.pdf");
            }
            catch (Exception ex)
            {
                TL.LogMessage("PlatformFiles", "Exception: " + ex.ToString());
            ...
            try
            {
                fileList.Add(@"$TARGETDIR$\Developer Documentation\Platform 6 Client-Driver Interaction V2.pdf");
                TL.LogMessage("DeveloperFiles", @"Added file: $TARGETDIR$\Developer Documentation\Platform 6 Client-Driver Interaction V2.pdf");
            }
            catch (Exception ex)
            {
                TL.LogMessage("PlatformFiles", "Exception: " + ex.ToString());
            ...
            try
            {
                fileList.Add(@"$TARGETDIR$\Developer Documentation\Platform Evolution.pdf");
                TL.LogMessage("DeveloperFiles", @"Added file: $TARGETDIR$\Developer Documentation\Platform Evolution.pdf");
            }
            catch (Exception ex)
            {
                TL.LogMessage("PlatformFiles", "Exception: " + ex.ToString());
            ...
            try
            {
                fileList.Add(@"$TARGETDIR$\Developer Documentation\PlatformDeveloperHelp.chm");
                TL.LogMessage("DeveloperFiles", @"Added file: $TARGETDIR$\Developer Documentation\PlatformDeveloperHelp.chm");
            }
            catch (Exception ex)
            {
                TL.LogMessage("PlatformFiles", "Exception: " + ex.ToString());
            ...
            try
            {
                fileList.Add(@"$TARGETDIR$\Developer Documentation\Script56.chm");
                TL.LogMessage("DeveloperFiles", @"Added file: $TARGETDIR$\Developer Documentation\Script56.chm");
            }
            catch (Exception ex)
            {
                TL.LogMessage("PlatformFiles", "Exception: " + ex.ToString());
            ...
            try
            {
                fileList.Add(@"$TARGETDIR$\Developer Documentation\Templates.html");
                TL.LogMessage("DeveloperFiles", @"Added file: $TARGETDIR$\Developer Documentation\Templates.html");
            }
            catch (Exception ex)
            {
                TL.LogMessage("PlatformFiles", "Exception: " + ex.ToString());
            ...
            try
            {
                fileList.Add(@"$TARGETDIR$\Developer Documentation\tip.gif");
                TL.LogMessage("DeveloperFiles", @"Added file: $TARGETDIR$\Developer Documentation\tip.gif");
            }
            catch (Exception ex)
            {
                TL.LogMessage("PlatformFiles", "Exception: " + ex.ToString());
            ...
            try
            {
                fileList.Add(@"$TARGETDIR$\Developer Documentation\wsh-56.chm");
                TL.LogMessage("DeveloperFiles", @"Added file: $TARGETDIR$\Developer Documentation\wsh-56.chm");
            }
            catch (Exception ex)
            {
                TL.LogMessage("PlatformFiles", "Exception: " + ex.ToString());
            ...
            try
            {
                fileList.Add(@"$TARGETDIR$\Installer Generator\InstallerGen.exe");
                TL.LogMessage("DeveloperFiles", @"Added file: $TARGETDIR$\Installer Generator\InstallerGen.exe");
            }
            catch (Exception ex)
            {
                TL.LogMessage("PlatformFiles", "Exception: " + ex.ToString());
            ...
            try
            {
                fileList.Add(@"$TARGETDIR$\Installer Generator\InstallerGen.pdb");
                TL.LogMessage("DeveloperFiles", @"Added file: $TARGETDIR$\Installer Generator\InstallerGen.pdb");
            }
            catch (Exception ex)
            {
                TL.LogMessage("PlatformFiles", "Exception: " + ex.ToString());
            ...
            try
            {
                fileList.Add(@"$TARGETDIR$\Installer Generator\Microsoft.Samples.WinForms.Extras.dll");
                TL.LogMessage("DeveloperFiles", @"Added file: $TARGETDIR$\Installer Generator\Microsoft.Samples.WinForms.Extras.dll");
            }
            catch (Exception ex)
            {
                TL.LogMessage("PlatformFiles", "Exception: " + ex.ToString());
            ...
            try
            {
                fileList.Add(@"$TARGETDIR$\Installer Generator\Microsoft.Samples.WinForms.Extras.pdb");
                TL.LogMessage("DeveloperFiles", @"Added file: $TARGETDIR$\Installer Generator\Microsoft.Samples.WinForms.Extras.pdb");
            }
            catch (Exception ex)
            {
                TL.LogMessage("PlatformFiles", "Exception: " + ex.ToString());
            ...
            try
            {
                fileList.Add(@"$TARGETDIR$\Installer Generator\Resources\CreativeCommons.txt");
                TL.LogMessage("DeveloperFiles", @"Added file: $TARGETDIR$\Installer Generator\Resources\CreativeCommons.txt");
            }
            catch (Exception ex)
            {
                TL.LogMessage("PlatformFiles", "Exception: " + ex.ToString());
            ...
            try
            {
                fileList.Add(@"$TARGETDIR$\Installer Generator\Resources\DriverInstallTemplate.iss");
                TL.LogMessage("DeveloperFiles", @"Added file: $TARGETDIR$\Installer Generator\Resources\DriverInstallTemplate.iss");
            }
            catch (Exception ex)
            {
                TL.LogMessage("PlatformFiles", "Exception: " + ex.ToString());
            ...
            try
            {
                fileList.Add(@"$TARGETDIR$\Installer Generator\Resources\WizardImage.bmp");
                TL.LogMessage("DeveloperFiles", @"Added file: $TARGETDIR$\Installer Generator\Resources\WizardImage.bmp");
            }
            catch (Exception ex)
            {
                TL.LogMessage("PlatformFiles", "Exception: " + ex.ToString());
            ...
            try
            {
                fileList.Add(@"$TARGETDIR$\Installer Generator\TemplateSubstitutionParameters.txt");
                TL.LogMessage("DeveloperFiles", @"Added file: $TARGETDIR$\Installer Generator\TemplateSubstitutionParameters.txt");
            }
            catch (Exception ex)
            {
                TL.LogMessage("PlatformFiles", "Exception: " + ex.ToString());
            ...
            try
            {
                fileList.Add(@"$TARGETDIR$\Sample Scripts\check-earth.js");
                TL.LogMessage("DeveloperFiles", @"Added file: $TARGETDIR$\Sample Scripts\check-earth.js");
            }
            catch (Exception ex)
            {
                TL.LogMessage("PlatformFiles", "Exception: " + ex.ToString());
            ...
            try
            {
                fileList.Add(@"$TARGETDIR$\Sample Scripts\check-planet.js");
                TL.LogMessage("DeveloperFiles", @"Added file: $TARGETDIR$\Sample Scripts\check-planet.js");
            }
            catch (Exception ex)
            {
                TL.LogMessage("PlatformFiles", "Exception: " + ex.ToString());
            ...
            try
            {
                fileList.Add(@"$TARGETDIR$\Sample Scripts\check-star.vbs");
                TL.LogMessage("DeveloperFiles", @"Added file: $TARGETDIR$\Sample Scripts\check-star.vbs");
            }
            catch (Exception ex)
            {
                TL.LogMessage("PlatformFiles", "Exception: " + ex.ToString());
            ...
            try
            {
                fileList.Add(@"$TARGETDIR$\Sample Scripts\KepNovSample.vbs");
                TL.LogMessage("DeveloperFiles", @"Added file: $TARGETDIR$\Sample Scripts\KepNovSample.vbs");
            }
            catch (Exception ex)
            {
                TL.LogMessage("PlatformFiles", "Exception: " + ex.ToString());
            ...
            try
            {
                fileList.Add(@"$TARGETDIR$\Sample Scripts\LocalTopoToJ2000.js");
                TL.LogMessage("DeveloperFiles", @"Added file: $TARGETDIR$\Sample Scripts\LocalTopoToJ2000.js");
            }
            catch (Exception ex)
            {
                TL.LogMessage("PlatformFiles", "Exception: " + ex.ToString());
            ...
            try
            {
                fileList.Add(@"$TARGETDIR$\Sample Scripts\TransformCheck.vbs");
                TL.LogMessage("DeveloperFiles", @"Added file: $TARGETDIR$\Sample Scripts\TransformCheck.vbs");
            }
            catch (Exception ex)
            {
                TL.LogMessage("PlatformFiles", "Exception: " + ex.ToString());
            ...
            try
            {
                fileList.Add(@"$TARGETDIR$\Templates\*.zip");
                TL.LogMessage("DeveloperFiles", @"Added file: $TARGETDIR$\Templates\*.zip");
            }
            catch (Exception ex)
            {
                TL.LogMessage("PlatformFiles", "Exception: " + ex.ToString());
