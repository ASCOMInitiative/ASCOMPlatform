...
//
// ASCOM Camera driver for CameraTemplateProjectCS
//
...
namespace ASCOM.CameraTemplateProjectCS
	{
	//
	// Your driver's ID is ASCOM.CameraTemplateProjectCS.Camera
	//
	// The Guid attribute sets the CLSID for ASCOM.CameraTemplateProjectCS.Camera
	// The ClassInterface/None addribute prevents an empty interface called
	// _Camera from being created and used as the [default] interface
	//
	[Guid("569d6205-9e10-4acd-bfd8-1b143de87041")]
	...
	public class Camera : ICamera
		...
		//
		private static string s_csDriverID = "ASCOM.CameraTemplateProjectCS.Camera";
		// TODO Change the descriptive string for your driver then remove this line
		private static string s_csDriverDescription = "CameraTemplateProjectCS Camera";
		...
		private static void RegUnregASCOM(bool bRegister)
			...
			try
				...
				P.DeviceType = "Camera";					//  Requires HelperNET
				if (bRegister)
