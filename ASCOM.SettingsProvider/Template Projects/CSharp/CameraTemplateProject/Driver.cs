...
//
// ASCOM Camera driver for CameraTemplateProject
//
...
{
	//
	// Your driver's ID is ASCOM.CameraTemplateProject.Camera
	//
	// The Guid attribute sets the CLSID for ASCOM.CameraTemplateProject.Camera
	// The ClassInterface/None addribute prevents an empty interface called
	// _Camera from being created and used as the [default] interface
	//
	[Guid("c9590056-0f6d-409e-8de5-fb0553702043")]
	...
	public class Camera : ICamera
	{
		...
		//
		private static string s_csDriverID = "ASCOM.CameraTemplateProject.Camera";
		// TODO Change the descriptive string for your driver then remove this line
		private static string s_csDriverDescription = "CameraTemplateProject Camera";
