...
namespace ASCOM.DriverAccess
{
    ...
    /// <summary>
    /// Provides universal access to Video drivers. (Please note that CommandXXX members are not present in the IVideo interface.)
    /// </summary>
    public class Video : AscomDriver, IVideo
    {
        ...
        #region Work-round to prevent use of the CommandXXX members that are not present in the IVideo interface.

        // The CommandXXX members are not present in the IVideo interface although they are part of the AscomDriver base class.
        // This is a problem because we want to retain ASCOMDriver as a base class that can refer to a driver of any device type.
        // To work round this, replacement members marked obsolete are defined here replace the same named members defined in the ASCOMDriver class.
        // This results in a compilation error being generated at compile time if the members are used and also results in the members being marked as deprecated in the DriverAccess component help file.

        /// <summary>
        /// CommandBlind is not a member of the IVideo interface and cannot be used through DriverAccess
        /// </summary>
        /// <param name="Command">Not applicable.</param>
        /// <param name="Raw">Not applicable.</param>
        [Obsolete("CommandBlind is not a member of the IVideo interface and cannot be used through DriverAccess.", true)]
        public new void CommandBlind(string Command, bool Raw)
        {
        }

        /// <summary>
        /// CommandBool is not a member of the IVideo interface and cannot be used through DriverAccess
        /// </summary>
		/// <param name="Command">Not applicable.</param>
		/// <param name="Raw">Not applicable.</param>
        /// <returns>Nothing - generates an error at compile time.</returns>
        [Obsolete("CommandBool is not a member of the IVideo interface and cannot be used through DriverAccess.", true)]
        public new bool CommandBool(string Command, bool Raw)
        {
            return false;
        }

        /// <summary>
        /// CommandString is not a member of the IVideo interface and cannot be used through DriverAccess
        /// </summary>
		/// <param name="Command">Not applicable.</param>
		/// <param name="Raw">Not applicable.</param>
        /// <returns>Nothing - generates an error at compile time.</returns>
        [Obsolete("CommandString is not a member of the IVideo interface and cannot be used through DriverAccess.", true)]
        public new string CommandString(string Command, bool Raw)
        {
            return "";
        }
