...
namespace ASCOM.DriverAccess
{
    ...
    public class Focuser : AscomDriver, IFocuserV3
    {
        ...
        /// </summary>
        /// <remarks><para>Raises an exception if ambient temperature is not available. Commonly available on focusers with a built-in temperature compensation mode.</para>
