'The purpose of these classes is to match the standards used in the .HelperNET components to the
...
Namespace VB6HelperSupport 'Tuck this out of the way of the main ASCOM.HelperNET namespace
...
#Region "New and IDisposable Support"
        Public Sub New()
            ...
            'MyBase.New()
            'Try
            'Profile = New ASCOM.HelperNET.XMLAccess("Unspecified Component")
...
#End Region
        ...
        'This exposes a new .HelperNET serial port so that it can be accessed through the VB6 helper component
        ...
        Public Property PortSpeed() As Integer
            Get
                Select Case SerPort.Speed
                    Case Serial.PortSpeed.ps300 : Return 300
                    Case Serial.PortSpeed.ps1200 : Return 1200
                    Case Serial.PortSpeed.ps2400 : Return 2400
                    Case Serial.PortSpeed.ps4800 : Return 4800
                    Case Serial.PortSpeed.ps9600 : Return 9600
                    Case Serial.PortSpeed.ps14400 : Return 14400
                    Case Serial.PortSpeed.ps19200 : Return 19200
                    Case Serial.PortSpeed.ps28800 : Return 28800
                    Case Serial.PortSpeed.ps38400 : Return 38400
                    Case Serial.PortSpeed.ps57600 : Return 57600
                    Case Serial.PortSpeed.ps115200 : Return 115200
                End Select
            End Get
            Set(ByVal value As Integer)
                Select Case value
                    Case 300 : SerPort.Speed = Serial.PortSpeed.ps300
                    Case 1200 : SerPort.Speed = Serial.PortSpeed.ps1200
                    Case 2400 : SerPort.Speed = Serial.PortSpeed.ps2400
                    Case 4800 : SerPort.Speed = Serial.PortSpeed.ps4800
                    Case 9600 : SerPort.Speed = Serial.PortSpeed.ps9600
                    Case 14400 : SerPort.Speed = Serial.PortSpeed.ps14400
                    Case 19200 : SerPort.Speed = Serial.PortSpeed.ps19200
                    Case 28800 : SerPort.Speed = Serial.PortSpeed.ps28800
                    Case 34000 : SerPort.Speed = Serial.PortSpeed.ps38400
                    Case 57600 : SerPort.Speed = Serial.PortSpeed.ps57600
                    Case 115200 : SerPort.Speed = Serial.PortSpeed.ps115200
                End Select
            End Set
        End Property
...
#End Region
        ...
        'This exposes a new .HelperNET chooser so that it can be accessed through the VB6 helper component
        Private myChooser As HelperNET.Chooser
        Private disposedValue As Boolean = False        ' To detect redundant calls
...
#Region "New, IDisposable and Finalize"
        Public Sub New()
            ...
            MyBase.New()
            Try
                'MsgBox("VB6Helper Before New HelperNET.Chooser")
                myChooser = New HelperNET.Chooser
                'MsgBox("VB6Helper After New HelperNET.Chooser")
            Catch ex As Exception
