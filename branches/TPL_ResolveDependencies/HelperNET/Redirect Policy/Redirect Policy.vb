...
Module RedirectPolicy
    ...
    Private Const HELPERNET_ASSEMBLY_NAME As String = "ASCOM.HelperNET" ' Don't add .dll

    Private Const AL_LINK As String = POLICY_FILE_NAME
    'Private Const AL_OUT As String = "policy.5.0.ASCOM.HelperNET.dll"
    ...
    Private Const AL_PRODUCT As String = "ASCOM.HelperNET"
    ...
    Sub Main()
        ...
        Try
            ProfAss = Assembly.ReflectionOnlyLoadFrom("..\..\..\HelperNET\Bin\Release\" & HELPERNET_ASSEMBLY_NAME & ".dll")
            Try
                ...
                Al_Out = "policy." & Ver.Major.ToString & "." & Ver.Minor.ToString & "." & HELPERNET_ASSEMBLY_NAME & ".dll"
                ...
                Try
                    ...
                    My.Computer.FileSystem.WriteAllText(POLICY_FILE_NAME, "            <assemblyIdentity name=""" & HELPERNET_ASSEMBLY_NAME & """ publicKeyToken=""565de7938946fba7"" culture=""neutral"" />" & vbCrLf, True, System.Text.ASCIIEncoding.ASCII)
                ...
                End Try
            Catch ex As Exception
                Console.WriteLine("Exception accessing HelperNET assembly: " & ex.ToString)
            End Try
    End Sub
