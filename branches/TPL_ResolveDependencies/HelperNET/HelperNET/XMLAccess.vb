...
#Region "New and IDisposable Support"
    Public Sub New()
        ...
        Try
            If Not FileStore.Exists("\" & VALUES_FILENAME) Then Throw New ProfileNotFoundException("HelperNET Error Base key does not exist")
        ...
        Catch ex As ProfileNotFoundException
            MsgBox("Migrating ASCOM Profiles from registry to file system" & vbCrLf & vbCrLf & "You should only see this message once, if not, please post on Yahoo group ASCOM-Talk", , "ASCOM HelperNET")
