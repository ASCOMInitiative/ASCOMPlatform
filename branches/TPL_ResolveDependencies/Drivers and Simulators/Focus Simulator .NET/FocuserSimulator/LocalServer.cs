//
// FocuserSimulator Local COM Server
//
...
namespace ASCOM.FocuserSimulator
{
    public class FocuserSimulator
    {
        ...
        private static string m_sAppId = "{1be665b3-c834-46db-b102-bd3ea4256d7b}";	// Our AppId
        #endregion
        ...
        // the FocuserSimulator\bin\Debug subfolder.
        //
        private static bool LoadComObjectAssemblies()
        {
            ...
            int i = assyPath.LastIndexOf(@"\FocuserSimulator\bin\");						// Look for us running in IDE
            if (i == -1) i = assyPath.LastIndexOf('\\');
            assyPath = assyPath.Remove(i, assyPath.Length - i) + "\\FocuserSimulatorServedClasses";
            ...
            foreach (FileInfo fi in d.GetFiles("*.dll"))
            {
                ...
                catch (Exception e)
                {
                    MessageBox.Show("Failed to load served COM class assembly " + fi.Name + " - " + e.Message,
                        "FocuserSimulator", MessageBoxButtons.OK, MessageBoxIcon.Stop);
                    return false;
                }
                ...
                switch (args[0].ToLower())
                {
                    ...
                    default:
                        MessageBox.Show("Unknown argument: " + args[0] + "\nValid are : -register, -unregister and -embedding",
                            "FocuserSimulator", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                        break;
                }
            }
            else
