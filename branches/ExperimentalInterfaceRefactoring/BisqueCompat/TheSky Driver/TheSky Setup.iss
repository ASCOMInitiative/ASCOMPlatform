...
AppVerName=ASCOM TheSky Telescope Driver 5.0.3
AppVersion=5.0.3
...
OutputDir="."
OutputBaseFilename="TheSkyTelescope(5.0.3)Setup"
Compression=lzma
...
Source: "D:\Astro Projects\ASCOM Platform 5 Drivers\TheSky Driver\TheSky Driver.dll"; DestDir: "{app}" ;AfterInstall: RegASCOM(); Flags: regserver
; Optional source files (COM and .NET aware)
Source: "D:\Astro Projects\ASCOM Platform 5 Drivers\TheSky Driver\*"; Excludes: *.zip,*.exe,*.dll, \bin\*, \obj\*; DestDir: "{app}\Source\TheSky Driver"; Tasks: source; Flags: recursesubdirs
Source: "D:\Astro Projects\ASCOM Platform 5 Drivers\TheSky Driver\TheSky Driver-ref.dll"; DestDir: "{app}\Source\TheSky Driver"; Tasks: source;
; TODO: Add other files needed by your driver here (add subfolders above)
Source: "D:\Astro Projects\ASCOM Platform 5 Drivers\TheSky Driver\astro32.dll"; DestDir: "{app}"; Flags: sharedfile
Source: "D:\Astro Projects\ASCOM Platform 5 Drivers\TheSky Driver\astro32.dll"; DestDir: "{app}\Source\TheSky Driver"; Tasks: source;
