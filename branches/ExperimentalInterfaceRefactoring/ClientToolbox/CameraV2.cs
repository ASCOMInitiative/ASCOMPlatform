...
namespace ASCOM.DriverAccess
{
    ...
    /// </summary>
    [ComVisible(true), Guid("F44E1FBA-FC04-4076-9084-2255958335A7"), ClassInterface(ClassInterfaceType.None)]
    public class CameraV2 : ICameraV2, IDisposable
    {
	...
	#region Camera New
        ...
        public CameraV2(string cameraID)
		{
