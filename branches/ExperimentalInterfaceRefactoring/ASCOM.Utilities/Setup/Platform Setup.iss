...
; Switched to using ASCOM.InterfacesVB
; Setup build 22
...
Source: ..\..\ASCOM.InterfacesVB\bin\Release\ASCOM.DeviceInterfaces.dll; DestDir: {app}; Flags: ignoreversion
Source: ..\..\ASCOM.InterfacesVB\bin\Release\ASCOM.DeviceInterfaces.pdb; DestDir: {app}; Flags: ignoreversion
...
Filename: {app}\GACInstall.exe; Parameters: ASCOM.DeviceInterfaces.dll; Flags: runhidden; StatusMsg: Installing ASCOM.Interface6 to the assembly cache
...
; ASCOM DeviceInterfaces
Filename: {app}\GACInstall.exe; Parameters: "/U ""ASCOM.DeviceInterfaces"""; Flags: runhidden; StatusMsg: Uninstalling ASCOM.Interface6 from the assembly cache
