...
Friend Class UtilitiesSettings
    Implements IDisposable

    Private m_HKCU, m_SettingsKey As RegistryKey
    Private Const REGISTRY_CONFORM_FOLDER As String = "Software\ASCOM\Utilities"

    'Constants used in the Parameters section
    Private Const TRACE_XMLACCESS As String = "Trace XMLAccess", TRACE_XMLACCESS_DEFAULT As Boolean = False 'Enable XML Access tracing
    Private Const TRACE_PROFILE As String = "Trace Profile", TRACE_PROFILE_DEFAULT As Boolean = False 'Enable Profile Tracing
    Private Const PROFILE_ROOT_EDIT As String = "Profile Root Edit", PROFILE_ROOT_EDIT_DEFAULT As Boolean = False 'Allow root editing in Profile Explorer
