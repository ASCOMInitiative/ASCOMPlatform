namespace ASCOM.Simulator.Config
{
	partial class ucGeneral
	{
		...
		private void InitializeComponent()
		{
			...
			this.bcxTraceLevel = new System.Windows.Forms.ComboBox();
			...
			// bcxTraceLevel
			// 
			this.bcxTraceLevel.DropDownStyle = System.Windows.Forms.ComboBoxStyle.DropDownList;
			this.bcxTraceLevel.FormattingEnabled = true;
			this.bcxTraceLevel.Location = new System.Drawing.Point(80, 274);
			this.bcxTraceLevel.Name = "bcxTraceLevel";
			this.bcxTraceLevel.Size = new System.Drawing.Size(93, 21);
			this.bcxTraceLevel.TabIndex = 34;
			// 
			// label1
			// 
			...
			this.Controls.Add(this.bcxTraceLevel);
		...
		private System.Windows.Forms.ComboBox bcxTraceLevel;
