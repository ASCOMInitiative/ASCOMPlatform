...
var u = new ActiveXObject("ASCOM.Utilities.Util")

var s = new ActiveXObject("ASCOM.Astrometry.NOVASCOM.Site");
...
var n = new ActiveXObject("ASCOM.Astrometry.NOVASCOM.Planet");
n.Ephemeris = new ActiveXObject("ASCOM.Astrometry.Kepler.Ephemeris");
n.EarthEphemeris = new ActiveXObject("ASCOM.Astrometry.Kepler.Ephemeris");   // NOVAS sets up Kepler
...
for(i = 0; i < jd.length; i++)
{
    ...
    WScript.Echo("  Astrometric:\r\n" +
				...
				"\r\n   Dist = " + u.FormatVar(p.Distance, "0.000000") + 
