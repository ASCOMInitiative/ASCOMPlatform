...
namespace ASCOM.Simulator.Dome
{
    //
    // Your driver's ID is ASCOM.Simulator.Dome
    //
    // The Guid attribute sets the CLSID for ASCOM.Dome.Dome
    // The ClassInterface/None addribute prevents an empty interface called
    // _Dome from being created and used as the [default] interface
    //
    [Guid("0529dfc1-44d5-4e75-8014-56a4d831eddf")]
    ...
    public class Dome : IDome
    {
        ...
        //
        private static string s_csDriverID = "ASCOM.Simulator.Dome";
        // TODO Change the descriptive string for your driver then remove this line
        private static string s_csDriverDescription = "Simulated Dome";
