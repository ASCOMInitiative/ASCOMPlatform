//
// ASCOM.Simulators.ObservingConditions Local COM Server
//
...
namespace ASCOM.Simulator
{
    public static class Server
    {
        ...
        const int WM_QUIT = 0x0012; // Message loop Quit code
        ...
        public static frmMain s_MainForm = null;				// Reference to our main form
        ...
        private static string s_appId = "{7c5bf729-d149-4305-adaf-f940374ece7e}";	// Our AppId
        ...
        public static int CountObject()
        {
			...
			Hub.TL.LogMessage("CountObject", "Incrementing object count to: " + (objsInUse + 1));
        ...
        public static int UncountObject()
        {
            ...
            Hub.TL.LogMessage("UncountObject", "Decrementing object count to: " + (objsInUse - 1));
        ...
        public static int CountLock()
        {
            ...
            Hub.TL.LogMessage("CountLock", "Incrementing lock count to: " + (serverLocks + 1));
        ...
        public static int UncountLock()
        {
            ...
            Hub.TL.LogMessage("UncountLock", "Decrementing lock count to: " + (serverLocks - 1));
        ...
        public static void ExitIf()
        {
            lock (lockObject)
            {
                Hub.TL.LogMessage("ExitIf", "Object Count: " + +ObjectsCount + ", Server Lock Count: " + ServerLockCount + ", Started by COM: " + StartedByCOM);
            ...
            foreach (FileInfo fi in d.GetFiles("*.dll"))
            {
                ...
                try
                {
                    ...
                    foreach (Type type in types)
                    {
                        ...
                        //MessageBox.Show("Attributes length: " +attrbutes.Length);
                ...
                catch (ReflectionTypeLoadException e)
                {
                    MessageBox.Show("Failed to load served COM class assembly " + fi.Name + " - " + e.ToString(),
                        "ObservingConditions Hub", MessageBoxButtons.OK, MessageBoxIcon.Stop);
        ...
        private static void ElevateSelf(string arg)
        {
            ...
            {
                MessageBox.Show("The Observing Conditions Hub was not " + (arg == "/register" ? "registered" : "unregistered") +
                    " because you did not allow it.", "Observing Conditions Hub", MessageBoxButtons.OK, MessageBoxIcon.Warning);
            }
            catch (Exception ex)
            {
                MessageBox.Show(ex.ToString(), "Observing Conditions Hub", MessageBoxButtons.OK, MessageBoxIcon.Stop);
            }
            return;
        }
        ...
        private static void RegisterObjects()
        {
            ...
            catch (Exception ex)
            {
                MessageBox.Show("Error while registering the server:\n" + ex.ToString(),
                        "Observing Conditions Hub", MessageBoxButtons.OK, MessageBoxIcon.Stop);
                return;
            }
            finally
            {
                ...
                switch (args[0].ToLower())
                {
                    ...
                    default:
                        MessageBox.Show("Unknown argument: " + args[0] + "\nValid are : -register, -unregister and -embedding",
                            "Observing Conditions Hub", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                        break;
                }
            }
            else
        ...
        static void Main(string[] args)
        {
            ...
            if (StartedByCOM) s_MainForm.WindowState = FormWindowState.Normal;
