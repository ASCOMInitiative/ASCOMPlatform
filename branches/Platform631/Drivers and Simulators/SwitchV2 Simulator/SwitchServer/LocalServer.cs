//
// ASCOM.SwitchServer Local COM Server
//
...
namespace ASCOM.Simulator
{
    public static class Server
    {
        ...
        private static string s_appId = "{6169b220-27ca-46d4-879a-059484d9fb8a}";	// Our AppId
        ...
        private static void ElevateSelf(string arg)
        {
            ...
            {
                MessageBox.Show("The SwitchServer was not " + (arg == "/register" ? "registered" : "unregistered") +
                    " because you did not allow it.", "SwitchServer", MessageBoxButtons.OK, MessageBoxIcon.Warning);
            }
            catch (Exception ex)
            {
                MessageBox.Show(ex.ToString(), "SwitchServer", MessageBoxButtons.OK, MessageBoxIcon.Stop);
            }
            return;
        }
                ...
                switch (args[0].ToLower())
                {
                    ...
                    default:
                        MessageBox.Show("Unknown argument: " + args[0] + "\nValid are : -register, -unregister and -embedding",
                            "SwitchServer", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                        break;
                }
            }
            else
