...
typedef void (*NOARGPROC)();
typedef void (*CBPBPROC)(PGaze, pBoolean, pBoolean*);
...
extern bool _bScopeCanMoveAxis;
extern bool _bStartCenter;
extern bool	_bScopeBusy	;
extern bool	_bIsSlewing;
extern bool _bAutoTrack;

extern bool _bV8Plugin;
extern bool _bV10Plugin;
extern SPSPROC _psn_SetPluginStatusText;
extern NOARGPROC _psn_RefreshPanel;
extern CBPBPROC _psn_GetAreCoordinatesWithingUserSlewLimits;
...
extern bool GetCanMoveAxis(void);
...
extern short SlewScope( PScopeMotion* inMotionParam );
