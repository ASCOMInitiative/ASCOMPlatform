...
Public Class Transform
    Implements Interfaces.ITransform, IDisposable
    ...
    Private Earth As NOVAS2.BodyStruct
    Private CatEntry As NOVAS2.CatEntryStruct
    Private Site As NOVAS2.SiteInfoStruct
...
#Region "New and IDisposable"
    Sub New()
        ...
        Earth.Name = "Earth"
        Earth.Number = NOVAS2.Body.Earth
        Earth.Type = NOVAS2.BodyType.MajorPlanet
...
#Region "ITransform Implementation"
    ...
    ''' a SetApparent and one of the Site properties has not been set.</exception>
    ''' <remarks></remarks>
    ReadOnly Property DECJTopocentric() As Double Implements ITransform.DECTopocentric
        Get
            ...
            Recalculate()
            CheckSet("DECJTopocentric", DECTopoValue, "DEC topocentric can not be derived from the information provided. Are site parameters set?")
            TL.LogMessage("DECJTopocentric Get", Utl.DegreesToDMS(DECTopoValue, ":", ":", "", 3))
            Return DECTopoValue
        End Get
    End Property
    ''' <summary>
...
#Region "Support Code"
    ...
    Private Sub J2000ToTopo()
        Dim rc As Short, RefracOption As NOVAS2.RefractionOption
        ...
        If RefracValue Then
            RefracOption = NOVAS2.RefractionOption.LocationRefraction
        Else
            RefracOption = NOVAS2.RefractionOption.NoRefraction
        End If
    ...
    Private Sub TopoToJ2000()
        ...
        Dim ct As Integer, rc As Short, RefracOption As NOVAS2.RefractionOption
        Dim JNow As Double
