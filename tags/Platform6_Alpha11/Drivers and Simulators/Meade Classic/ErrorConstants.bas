...
Public Const ERR_SOURCE As String = "ASCOM Meade Driver"
...
Public Const MSG_PULSE_DUR = _
    "Bad duration."
Public Const SCODE_AUTOSTARII As Long = vbObjectError + &H420
Public Const MSG_AUTOSTARII As String = _
    "Found a Meade Autostar II.  Please use an Autostar II driver."
Public Const SCODE_NOT_GEM As Long = vbObjectError + &H421
Public Const MSG_NOT_GEM As String = _
    "GEM can not be in Alt Az mode.  Please change this setup."
