...
' 05-Apr-07 rbd     5.0.2 - Remove " Drivers" from driver keys for new
'                   XML profile storage layer
'---------------------------------------------------------------------
Option Explicit
...
Private Sub Form_Load()
    ...
    '
    Set d = EnumKeys(m_sDeviceType, ERR_SOURCE_CHOOSER)    ' Get Key-Class pairs
...
Private Sub cmdProperties_Click()
    ...
    WriteProfile "Chooser", sProgID & " Init", "True", ERR_SOURCE_CHOOSER   ' Remember it has been initialized
...
Private Sub cbDriverSelector_Click()
    ...
    If Me.cbDriverSelector.ListIndex >= 0 Then      ' Something selected
        ...
        buf = GetProfile("Chooser", m_sProgID(cbDriverSelector.ItemData(cbDriverSelector.ListIndex)) & " Init", _
                        ERR_SOURCE_CHOOSER)
