...
namespace ASCOM
{
	...
	public class NotImplementedException : DriverException
	{
		...
		public NotImplementedException(string propertyOrMethod, System.Exception inner)
			: base(String.Format(CultureInfo.InvariantCulture, csMessage, propertyOrMethod), ErrorCodes.NotImplemented, inner)
		{
			PropertyOrMethod = propertyOrMethod;
		}
