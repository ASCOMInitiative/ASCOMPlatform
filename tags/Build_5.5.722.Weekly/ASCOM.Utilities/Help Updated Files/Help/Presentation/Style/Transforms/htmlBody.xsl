<!-- Search for PWGS to find changes for ASCOM -->
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0" 
  ...
  <!-- PWGS ASCOM defaults changed to off from on for protected, declared and inherited check boxes -->
  ...
  <xsl:template name="memberOptionsMenu">
    <div id="memberOptionsMenu">
      ...
      <input id="ProtectedCheckbox" type='checkbox' data="Protected" value="off" onClick="SetMemberOptions(this, 'vis')"/>
      ...
      <xsl:if test="$moreMemberOptions">
        <br/>
        <input id="DeclaredCheckbox" type='checkbox' data="Declared" value="off" onClick="SetMemberOptions(this, 'decl')"/>
        <label class="checkboxLabel" for="DeclaredCheckbox">
          <include item="includeDeclaredMembers"/>
        </label>
        <br/>
      </xsl:if>
      <input id="InheritedCheckbox" type='checkbox' data="Inherited" value="off" onClick="SetMemberOptions(this, 'decl')"/>
