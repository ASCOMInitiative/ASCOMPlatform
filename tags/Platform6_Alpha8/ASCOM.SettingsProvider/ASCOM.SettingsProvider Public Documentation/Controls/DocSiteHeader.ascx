<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DocSiteHeader.ascx.cs" Inherits="ASCOM.SettingsProvider_Public_Documentation.Controls.DocSiteHeader" %>
...
<asp:Image runat="server" id="logoImage" CssClass="docsite_logo" ImageUrl="~/Images/Logo.jpg" meta:resourcekey="logoImageResource1" />
<div id="docsite_header_title"><%= ASCOM.SettingsProvider_Public_Documentation.DocSite.ProjectTitle %></div>
<div id="docsite_header_company"><%= ASCOM.SettingsProvider_Public_Documentation.DocSite.ProjectCompany %></div>