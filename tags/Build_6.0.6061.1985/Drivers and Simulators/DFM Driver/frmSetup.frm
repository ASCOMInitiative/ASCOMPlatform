...
Begin VB.Form frmSetup 
   ...
   Begin VB.PictureBox picASCOM 
      ...
      Height          =   840
      Left            =   4005
      MouseIcon       =   "frmSetup.frx":182E
      MousePointer    =   99  'Custom
      Picture         =   "frmSetup.frx":1980
      ScaleHeight     =   840
      ScaleWidth      =   720
      TabIndex        =   6
      Top             =   210
   ...
   Begin VB.ComboBox lbPort 
      Height          =   315
      ItemData        =   "frmSetup.frx":2844
      Left            =   2235
      List            =   "frmSetup.frx":287F
   ...
   Begin VB.Label Label2 
      Caption         =   "Set the TCS for for 9600 baud."
      Height          =   285
      Left            =   1395
      TabIndex        =   4
      Top             =   705
...
'                   from someone else :-)
' 13-Oct-08 rbd     5.0.1 - For DFM TCS, changed layout and graphics.
'---------------------------------------------------------------------
...
Private Sub picDFM_Click()
    Dim z As Long

    z = ShellExecute(0, "Open", "http://www.dfmengineering.com/", 0, 0, SW_SHOWNORMAL)
    If (z > 0) And (z <= 32) Then
        MsgBox _
            "It doesn't appear that you have a web browser installed " & _
            "on your system.", (vbOKOnly + vbExclamation + vbMsgBoxSetForeground), ERR_SOURCE
