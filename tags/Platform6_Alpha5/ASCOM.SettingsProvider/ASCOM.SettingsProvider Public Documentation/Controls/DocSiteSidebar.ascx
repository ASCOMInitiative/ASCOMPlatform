<%@ Control Language="C#" AutoEventWireup="true" Codebehind="DocSiteSidebar.ascx.cs" Inherits="ASCOM.SettingsProvider_Public_Documentation.Controls.DocSiteSidebar" %>
