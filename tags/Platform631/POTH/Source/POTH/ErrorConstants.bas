...
Public Const ERR_SOURCE As String = "POTH"
...
Public Const SCODE_AMBIGUOUS_SOP As Long = vbObjectError + &H414
Public Const MSG_AMBIGUOUS_SOP As String = _
    "The pier side is unknown."
