...
'This version of Profile is identical to the version in Platform 5.5.1 except that it targets the registry rather
'than the XML file system used in Platform 5.5. This has been created for Platform 6 in order that applications and drivers coded
'against Platform 5.5.1 will continue to work when migrated to Platform 6.
