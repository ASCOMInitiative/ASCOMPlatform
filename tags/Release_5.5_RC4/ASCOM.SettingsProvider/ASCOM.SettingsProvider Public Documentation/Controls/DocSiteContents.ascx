<%@ Control Language="C#" AutoEventWireup="true" Codebehind="DocSiteContents.ascx.cs" Inherits="ASCOM.SettingsProvider_Public_Documentation.Controls.DocSiteContents" %>
