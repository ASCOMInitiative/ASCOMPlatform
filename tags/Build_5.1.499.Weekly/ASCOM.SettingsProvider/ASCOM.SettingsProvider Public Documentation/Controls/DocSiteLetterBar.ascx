<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DocSiteLetterBar.ascx.cs" Inherits="ASCOM.SettingsProvider_Public_Documentation.Controls.DocSiteLetterBar" %>
