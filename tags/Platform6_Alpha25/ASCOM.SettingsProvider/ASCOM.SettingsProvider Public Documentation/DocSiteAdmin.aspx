<%@ Page Language="C#" MasterPageFile="~/DocSite.Master" AutoEventWireup="true" CodeBehind="DocSiteAdmin.aspx.cs" Inherits="ASCOM.SettingsProvider_Public_Documentation.DocSiteAdmin" Title="ASCOM.SettingsProvider Public Documentation - Administration" 
...
<asp:Content ID="Content1" ContentPlaceHolderID="contentPlaceholder" runat="server">
  ...
  <asp:ObjectDataSource runat="server" ID="statisticsDataSource" TypeName="ASCOM.SettingsProvider_Public_Documentation.DocSiteAdmin" SelectMethod="GetStatisticsForBinding" />
	<asp:ObjectDataSource runat="server" ID="clientSettingsDataSource" TypeName="ASCOM.SettingsProvider_Public_Documentation.DocSiteAdmin" SelectMethod="GetSettingsForBinding" UpdateMethod="UpdateSettings"
	...
	<asp:ObjectDataSource runat="server" ID="searchSettingsDataSource" TypeName="ASCOM.SettingsProvider_Public_Documentation.DocSiteAdmin" SelectMethod="GetSettingsForBinding" UpdateMethod="UpdateSettings"
	                      DataObjectTypeName="DaveSexton.DocProject.DocSites.Configuration.DocSiteSettings, DaveSexton.DocProject.DocSites, Version=1.0.1.0, Culture=neutral, PublicKeyToken=af1a4bab65cc4ece" />
	<asp:ObjectDataSource runat="server" ID="keywordSettingsDataSource" TypeName="ASCOM.SettingsProvider_Public_Documentation.DocSiteAdmin" SelectMethod="GetSettingsForBinding" UpdateMethod="UpdateSettings"
	                      DataObjectTypeName="DaveSexton.DocProject.DocSites.Configuration.DocSiteSettings, DaveSexton.DocProject.DocSites, Version=1.0.1.0, Culture=neutral, PublicKeyToken=af1a4bab65cc4ece" />
	<asp:ObjectDataSource runat="server" ID="weightFactorsDataSource" TypeName="ASCOM.SettingsProvider_Public_Documentation.DocSiteAdmin" SelectMethod="GetSettingsForBinding" UpdateMethod="UpdateSettings"
	                      DataObjectTypeName="DaveSexton.DocProject.DocSites.Configuration.DocSiteSettings, DaveSexton.DocProject.DocSites, Version=1.0.1.0, Culture=neutral, PublicKeyToken=af1a4bab65cc4ece" />
	<asp:ObjectDataSource runat="server" ID="additionalWeightsDataSource" TypeName="ASCOM.SettingsProvider_Public_Documentation.DocSiteAdmin" SelectMethod="GetSettingsForBinding" UpdateMethod="UpdateSettings"
	                      DataObjectTypeName="DaveSexton.DocProject.DocSites.Configuration.DocSiteSettings, DaveSexton.DocProject.DocSites, Version=1.0.1.0, Culture=neutral, PublicKeyToken=af1a4bab65cc4ece" />
