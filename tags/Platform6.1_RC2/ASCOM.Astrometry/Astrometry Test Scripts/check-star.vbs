...
Dim star(3)
Set star(0) = CreateObject("ASCOM.Astrometry.NOVASCOM.Star")
star(0).DeltaT = 60.0
star(0).Catalog = "FK5"
star(0).Name = "Polaris"
star(0).Number = 0
...
Set star(1) = CreateObject("ASCOM.Astrometry.NOVASCOM.Star")
star(1).DeltaT = 60.0
star(1).Catalog = "FK5"
...
Set star(2) = CreateObject("ASCOM.Astrometry.NOVASCOM.Star")
star(2).DeltaT = 60.0
star(2).Catalog = "FK5"
...
For i = 0 to 3
	For j = 0 to 2
		...
		WScript.Echo("JD = " & time(i) & "  Star = " & star(j).Name & vbCrLf & _ 
		"RA = " & pos.RightAscension & "  Dec = " & pos.Declination & vbCrLf)
	Next
Next
