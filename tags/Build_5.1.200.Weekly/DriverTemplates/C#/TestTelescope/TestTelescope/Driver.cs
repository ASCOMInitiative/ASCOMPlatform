...
//
// ASCOM Telescope driver for TestTelescope
//
...
{
	//
	// Your driver's ID is ASCOM.TestTelescope.Telescope
	//
	// The Guid attribute sets the CLSID for ASCOM.TestTelescope.Telescope
	// The ClassInterface/None addribute prevents an empty interface called
	// _Telescope from being created and used as the [default] interface
	//
	[Guid("8c452c6e-3f90-4035-ab27-cc6d6719a5b2")]
	...
	public class Telescope : ITelescope
	{
		...
		//
		private static string s_csDriverID = "ASCOM.TestTelescope.Telescope";
		// TODO Change the descriptive string for your driver then remove this line
		private static string s_csDriverDescription = "TestTelescope Telescope";
	...
	//
	// The Guid attribute sets the CLSID for ASCOM.TestTelescope.Rate
	// The ClassInterface/None addribute prevents an empty interface called
	// _Rate from being created and used as the [default] interface
	//
	[Guid("bf06a0b0-078b-46d9-b2be-f1e2862894c9")]
	[ClassInterface(ClassInterfaceType.None)]
	...
	// this polymorphism. 
	//
	// The Guid attribute sets the CLSID for ASCOM.TestTelescope.AxisRates
	// The ClassInterface/None addribute prevents an empty interface called
	// _AxisRates from being created and used as the [default] interface
	//
	[Guid("aed14af3-074b-47e7-a70b-63254bb8cdfb")]
	[ClassInterface(ClassInterfaceType.None)]
	...
	// this polymorphism. 
	//
	// The Guid attribute sets the CLSID for ASCOM.TestTelescope.TrackingRates
	// The ClassInterface/None addribute prevents an empty interface called
	// _TrackingRates from being created and used as the [default] interface
	//
	[Guid("01204af2-1355-4811-bd13-22d4095335b5")]
	[ClassInterface(ClassInterfaceType.None)]
