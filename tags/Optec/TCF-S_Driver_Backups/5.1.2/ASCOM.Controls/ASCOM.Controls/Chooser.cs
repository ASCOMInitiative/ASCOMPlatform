...
namespace ASCOM.Controls
{
    ...
    public class Chooser : System.Windows.Forms.UserControl
    {
        ...
        internal void PopulateDeviceList()
        {
            ...
            {
                ArrayList installedDrivers = P.RegisteredDevices(this.DeviceClass);// Changed from Generic.SortedList for COM compatibility
                ...
                foreach (KeyValuePair deviceProfileKey in installedDrivers)
                {
