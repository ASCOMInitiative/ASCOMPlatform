...
*/
   ...
   EXPORT short int ter2cel (double jd_high, double jd_low, double delta_t, 
                      short int method, short int accuracy, 
   ...
   EXPORT void wobble (double tjd, double x, double y, double *pos1,
  ...
  EXPORT  short int cio_location (double jd_tdb, short int accuracy,
   ...
   EXPORT double norm_ang (double angle);
    ...
    EXPORT void make_cat_entry (char star_name[51], char catalog[4],
