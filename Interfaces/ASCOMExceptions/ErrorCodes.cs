...
namespace ASCOM
{
	...
	public static partial class ErrorCodes
	{
		...
		/// </remarks>
		public const int NotImplemented = unchecked((int)0x80040400);
		/// <summary>
		...
		/// </remarks>
		public const int InvalidValue = unchecked((int)0x80040401);
		/// <summary>
		...
		/// </remarks>
		public const int ValueNotSet = unchecked((int)0x80040402);
				/// <summary>
		/// Error code used to indicate that the communications channel is not connected.
		/// </summary>
		public const int NotConnected = unchecked((int)0x80040407);
		/// <summary>
		/// Error code used to indicate that the attempted operation is invalid because the mount
		/// is currently in a Parked state.
		/// </summary>
		public const int InvalidWhileParked = unchecked((int)0x80040408);
		/// <summary>
		/// Error code used to indicate that the attempted operation is invalid because the mount
		/// is currently in a Slaved state.
		/// </summary>
		public const int InvalidWhileSlaved = unchecked((int)0x80040409);
		/// <summary>
		/// An error related to settings.
		/// </summary>
		public const int SettingsProviderError = unchecked((int)0x8004040A);
		/// <summary>
		/// A 'catch-all' error code used when nothing else was specified.
		/// </summary>
		public const int UnspecifiedError = unchecked((int)0x800404FF);
		/// <summary>
		...
		/// </remarks>
		public const int DriverBase = unchecked((int)0x80040500);
		/// <summary>
		...
		/// DriverBase, up to and including DriverMax.
		/// </remarks>
		public const int DriverMax = unchecked((int)0x80040FFF);
	}
}
