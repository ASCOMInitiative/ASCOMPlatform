...
namespace ASCOM
{
    ...
    public class InvalidOperationException : DriverException
    {
        ...
        /// </summary>
        public InvalidOperationException() : base(csDefaultMessage, ErrorCodes.InvalidOperationException)
        {
        }
        ...
        public InvalidOperationException(Exception innerException) : base(csDefaultMessage, ErrorCodes.InvalidOperationException, innerException)
        {
        }
