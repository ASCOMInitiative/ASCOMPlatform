...
; Generated by Peter Simpson on 24/01/2020 (UTC)
;
[Setup]
AppID={{e3d0780a-1ff0-4d26-a235-d07bb6d56d59}
AppName=ASCOM ASCOM CoverCalibratorSimulator CoverCalibrator Driver
AppVerName=ASCOM ASCOM CoverCalibratorSimulator CoverCalibrator Driver 6.5
AppVersion=6.5
AppPublisher=Peter Simpson <peter@peterandjill.co.uk>
AppPublisherURL=mailto:peter@peterandjill.co.uk
AppSupportURL=http:https://ascomtalk.groups.io/g/Help/topics
...
OutputDir="."
OutputBaseFilename="ASCOM CoverCalibratorSimulator Setup"
Compression=lzma
...
UninstallFilesDir="{cf}\ASCOM\Uninstall\CoverCalibrator\ASCOM CoverCalibratorSimulator"

[Languages]
Name: "english"; MessagesFile: "compiler:Default.isl"

[Dirs]
Name: "{cf}\ASCOM\Uninstall\CoverCalibrator\ASCOM CoverCalibratorSimulator"
; TODO: Add subfolders below {app} as needed (e.g. Name: "{app}\MyFolder")

[Files]
Source: "..\bin\Debug\ASCOM.Simulator.CoverCalibrator.dll"; DestDir: "{app}"
; Require a read-me HTML to appear after installation, maybe driver's Help doc
; Source: "J:\ASCOM.Simulator.CoverCalibrator\bin\Debug\ReadMe.htm"; DestDir: "{app}"; Flags: isreadme
...
Filename: "{dotnet4032}\regasm.exe"; Parameters: "/codebase ""{app}\ASCOM.Simulator.CoverCalibrator.dll"""; Flags: runhidden 32bit
Filename: "{dotnet4064}\regasm.exe"; Parameters: "/codebase ""{app}\ASCOM.Simulator.CoverCalibrator.dll"""; Flags: runhidden 64bit; Check: IsWin64
...
[UninstallRun]
; Only for .NET assembly/in-proc drivers
Filename: "{dotnet4032}\regasm.exe"; Parameters: "-u ""{app}\ASCOM.Simulator.CoverCalibrator.dll"""; Flags: runhidden 32bit
; This helps to give a clean uninstall
Filename: "{dotnet4064}\regasm.exe"; Parameters: "/codebase ""{app}\ASCOM.Simulator.CoverCalibrator.dll"""; Flags: runhidden 64bit; Check: IsWin64
Filename: "{dotnet4064}\regasm.exe"; Parameters: "-u ""{app}\ASCOM.Simulator.CoverCalibrator.dll"""; Flags: runhidden 64bit; Check: IsWin64
