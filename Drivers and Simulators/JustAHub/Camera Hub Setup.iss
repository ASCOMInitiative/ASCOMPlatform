...
;
[Setup]
AppID={{14a6d19c-c6f9-42e6-93fb-7e09894f3c97}
AppName=ASCOM Camera Hub Camera Driver
AppVerName=ASCOM Camera Hub Camera Driver 6.6
AppVersion=6.6
...
OutputDir="."
OutputBaseFilename="Camera Hub Setup"
Compression=lzma
...
UninstallFilesDir="{cf}\ASCOM\Uninstall\Camera\Camera Hub"

[Languages]
Name: "english"; MessagesFile: "compiler:Default.isl"

[Dirs]
Name: "{cf}\ASCOM\Uninstall\Camera\Camera Hub"
; TODO: Add subfolders below {app} as needed (e.g. Name: "{app}\MyFolder")

[Files]
Source: "J:\ASCOMPlatform\Drivers and Simulators\CameraHub\ASCOM.CameraHub.exe"; DestDir: "{app}" ;AfterInstall: RegASCOM()
; Require a read-me HTML to appear after installation, maybe driver's Help doc
Source: "J:\ASCOMPlatform\Drivers and Simulators\CameraHub\ReadMe.htm"; DestDir: "{app}"; Flags: isreadme
...
Root: HKCR; Subkey: AppId\{#AppClsid}; ValueType: string; ValueData: "ASCOM Camera Hub Camera Driver"
...
begin
   ...
   P.DeviceType := 'Camera';
   P.Register('Camera Hub.Camera', 'ASCOM Camera Hub');
end;
...
begin
   ...
   begin
     P := CreateOleObject('ASCOM.Utilities.Profile');
     P.DeviceType := 'Camera';
     P.Unregister('Camera Hub.Camera');
  end;
end;
