...
{
	//
	// Your driver's DeviceID is ASCOM.SwitchSimulator.Driver
	//
	// The Guid attribute sets the CLSID for ASCOM.SwitchSimulator.Driver
	...
	public class Switch : ISwitch
	{
		...
		/// </summary>
		//private static string s_csDriverID = "ASCOM.SwitchSimulator.Driver";
		// TODO Change the descriptive string for your driver then remove this line
		/// <summary>
		/// Driver description that displays in the ASCOM Chooser.
		/// </summary>
		//private static string s_csDriverDescription = "ASCOM.SwitchSimulator Driver for Switch.";
        ...
        //    P.DeviceType = "ASCOM.SwitchSimulator.Driver";
        //    if (bRegister)
        //    {
