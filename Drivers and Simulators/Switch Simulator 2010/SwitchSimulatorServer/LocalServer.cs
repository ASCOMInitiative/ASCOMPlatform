...
// True if server started by COM (-embedding)
	...
	//
            ...
            assyPath = String.Format("{0}\\SwitchSimulatorServer\\SwitchSimulatorServedClasses", assyPath.Remove(i, assyPath.Length - i));
		...
		private static void RegisterObjects()
		{
			...
			foreach (Type type in m_ComObjectTypes)
			{
				...
				try
				{
					...
					string chooserName = ((ASCOM.ServedClassNameAttribute)attr).DisplayName ?? "SwitchSimulator";
