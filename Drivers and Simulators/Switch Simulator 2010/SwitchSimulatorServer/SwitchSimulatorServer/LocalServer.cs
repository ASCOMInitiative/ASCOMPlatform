//
// SwitchSimulatorServer Local COM Server
//
...
{
    public class SwitchSimulatorServer
    {
        ...
        private static string m_sAppId = "{2b204647-cd4d-4542-86ee-8271df61ce4b}";	// Our AppId
        #endregion
        ...
        public static int ObjectsCount
        {
            get
            {
                lock (typeof(SwitchSimulatorServer))
                {
                    return m_iObjsInUse;
                }
            }
        ...
        // the SwitchSimulatorServer\bin\Debug subfolder.
        //
        private static bool LoadComObjectAssemblies()
        {
            ...
            int i = assyPath.LastIndexOf(@"\SwitchSimulatorServer\bin\");						// Look for us running in IDE
            if (i == -1) i = assyPath.LastIndexOf('\\');
            assyPath = assyPath.Remove(i, assyPath.Length - i) + "\\SwitchSimulatorServerServedClasses";
            ...
            foreach (FileInfo fi in d.GetFiles("*.dll"))
            {
                ...
                catch (Exception e)
                {
                    MessageBox.Show("Failed to load served COM class assembly " + fi.Name + " - " + e.Message,
                        "SwitchSimulatorServer", MessageBoxButtons.OK, MessageBoxIcon.Stop);
                    return false;
                }
                ...
                switch (args[0].ToLower())
                {
                    ...
                    default:
                        MessageBox.Show("Unknown argument: " + args[0] + "\nValid are : -register, -unregister and -embedding",
                            "SwitchSimulatorServer", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                        break;
                }
            }
            else
