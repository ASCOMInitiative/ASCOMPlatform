...
namespace ASCOM.Simulator
{
    public partial class FocuserSettingsForm : Form
    {
        ...
        /// <summary>
        /// This is the method to run when the class is constructor
        /// </summary>
        ...
        /// <summary>
        /// This is the method to run when you want to turn the temperature probe off or on 
        /// </summary>
        ...
        /// <summary>
        /// This is the method to run when you want to turn the temperature compensator off or on
        /// </summary>
        ...
        private void radAbsoluteFocuser_CheckedChanged(object sender, EventArgs e)
        {
            RadioButton absoluteRadioButton= sender as RadioButton;

            // Test whether the absolute radio button has been checked or unchecked
            if (absoluteRadioButton.Checked) // Absolute mode has been selected
            {
                _focuser._position = _focuser._lastPosition;
                _focuser.Target=_focuser._position;
                _focuser.Absolute = true;
            }
            else // Relative mode has been selected
            {
                _focuser._lastPosition = _focuser._position;
                _focuser._position = 0;
                _focuser.Target = _focuser._position;
                _focuser.Absolute = false;
            }
            _focuser.Handbox.SetLabelText();
        }
    }
}
