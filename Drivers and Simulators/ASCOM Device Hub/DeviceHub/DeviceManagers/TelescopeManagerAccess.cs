...
namespace ASCOM.DeviceHub
{
    ...
    public partial class TelescopeManager : ITelescopeV4
    {
        ...
        private bool CheckDevice(bool testConnected, bool throwException)
        {
            ...
            if (Service == null) // Service is null
            {
                if (throwException)
                {
            ...
            {
                if (!Service.DeviceCreated) // Device has not been created
                {
                    if (throwException)
                    {
                        throw new NullReferenceException("The Telescope service has not been created.");
                    }
