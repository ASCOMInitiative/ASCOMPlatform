...
{
    public partial class FocuserManager : DeviceManagerBase, IFocuserManager, IFocuserV4, IDisposable
    {
        ...
        public bool ConnectFocuser()
        {
            ...
            return ConnectFocuser(FocuserID, false);
        }

        public bool ConnectFocuser(string focuserID, bool interactiveConnect = true)
        {
            ConnectError = "";
            ...
            if (IsConnected)
            {
                ...
                {
                    LogActivityLine(ActivityMessageTypes.Other, "Attempting to initialize focuser operation caught an un-handled exception. Details follow:");
        ...
        public void DisconnectFocuser(bool interactiveDisconnect = false)
        {
            if (!DeviceCreated)
            {
                return;
