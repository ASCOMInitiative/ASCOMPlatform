...
namespace TiGra.ASCOM.Controls
{
	/// <summary>
	...
	/// <summary>
	/// Summary description for LEDRedGreen.
	/// </summary>
	[DefaultProperty("LabelText")]
	public class LEDRedGreen : System.Windows.Forms.UserControl
	{
		/// <summary> 
		...
		/// <summary>
		/// Default constructor for a new LEDRedGreen object. Performs the default processing required
		/// by the designer.
		/// </summary>
		public LEDRedGreen()
		{
		...
		/// <summary>
		/// Refreshes the LED display
		/// ToDo: take account of the cadence bit.
		/// </summary>
