...
namespace ASCOM.DynamicRemoteClients
{
    ...
    public class ClassFactory : IClassFactory
    {
        ...
        public bool RegisterClassObject()
        {
            ...
            int i = NativeMethods.CoRegisterClassObject
                (
                ref m_ClassId,
                this,
                m_ClassContext,
        ...
        {
            int i = NativeMethods.CoRevokeClassObject(m_Cookie);
            return (i == 0);
        }

        public static bool ResumeClassObjects()
        {
            int i = NativeMethods.CoResumeClassObjects();
            return (i == 0);
        }

        public static bool SuspendClassObjects()
        {
            int i = NativeMethods.CoSuspendClassObjects();
            return (i == 0);
        }
        #endregion
