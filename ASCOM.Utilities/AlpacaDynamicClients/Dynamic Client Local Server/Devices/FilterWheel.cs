    ...
    public class FilterWheel : ReferenceCountedObjectBase, DeviceInterface.IFilterWheelV3, IDisposable
    {
        ...
        public FilterWheel()
        {
            try
            {
                ...
                // Create a client
                client = Server.GetClient<AlpacaFilterWheel>(state, TL);
        ...
        public void SetupDialog()
        {
            ...
            {
                AlpacaFilterWheel newclient = Server.SetupDialogue<AlpacaFilterWheel>(state, TL);
