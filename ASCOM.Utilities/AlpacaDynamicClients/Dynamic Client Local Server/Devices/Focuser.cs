...
namespace ASCOM.DynamicClients
{
    ...
    /// </summary>
    public class Focuser : ReferenceCountedObjectBase, DeviceInterface.IFocuserV4, IDisposable
    {
        // Set the device type of this device
        private const DeviceTypes deviceType = DeviceTypes.Focuser;

        // The ASCOM Library Alpaca client that is used to communicate with the Alpaca device.
        private AlpacaFocuser client;
        ...
        public Focuser()
        {
            try
            {
                ...
                // Create a client
                client = Server.GetClient<AlpacaFocuser>(state, TL);
        ...
        public void SetupDialog()
        {
            ...
            {
                AlpacaFocuser newclient = Server.SetupDialogue<AlpacaFocuser>(state, TL);
        ...
        public bool TempComp
        {
            get
            {
                return client.TempComp;
            }

            set
            {
                client.TempComp = value;
            }
        }
        ...
        public bool TempCompAvailable
        {
            get
            {
                return client.TempCompAvailable;
            }
        }
