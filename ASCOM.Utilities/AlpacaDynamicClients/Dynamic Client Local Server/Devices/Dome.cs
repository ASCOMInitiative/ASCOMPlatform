...
namespace ASCOM.DynamicClients
{
    ...
    /// </summary>
    public class Dome : ReferenceCountedObjectBase, DeviceInterface.IDomeV3, IDisposable
    {
        ...
        public bool CanSyncAzimuth
        {
            get
            {
                return client.CanSyncAzimuth;
            }
        }

        public DeviceInterface.ShutterState ShutterStatus
        {
            get
            {
                return (DeviceInterface.ShutterState)client.ShutterStatus;
            }
        }
