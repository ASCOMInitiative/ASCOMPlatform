    ...
    public class Rotator : ReferenceCountedObjectBase, DeviceInterface.IRotatorV4, IDisposable
    {
        ...
        public Rotator()
        {
            try
            {
                ...
                // Create a client
                client = Server.GetClient<AlpacaRotator>(state, TL);
        ...
        public void SetupDialog()
        {
            ...
            {
                AlpacaRotator newclient = Server.SetupDialogue<AlpacaRotator>(state, TL);
        ...
        public float MechanicalPosition
        {
            get
            {
                return client.MechanicalPosition;
            }
        }
