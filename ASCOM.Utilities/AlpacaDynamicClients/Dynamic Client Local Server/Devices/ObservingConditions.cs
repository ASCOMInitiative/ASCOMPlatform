...
namespace ASCOM.DynamicClients
{
    ...
    /// </summary>
    public class ObservingConditions : ReferenceCountedObjectBase, DeviceInterface.IObservingConditionsV2, IDisposable
    {
        ...
        public ObservingConditions()
        {
            try
            {
                ...
                // Create a client
                client = Server.GetClient<AlpacaObservingConditions>(state, TL);
        ...
        public void SetupDialog()
        {
            ...
            {
                AlpacaObservingConditions newclient = Server.SetupDialogue<AlpacaObservingConditions>(state, TL);
        ...
        {
            return client.SensorDescription(PropertyName);
        }
        ...
        public double AveragePeriod
        {
            get
            {
                return client.AveragePeriod;
            }

            set
            {
                client.AveragePeriod = value;
            }
        }
