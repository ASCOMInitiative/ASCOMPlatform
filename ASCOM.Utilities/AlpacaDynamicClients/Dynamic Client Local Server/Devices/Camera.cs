    ...
    public class Camera : ReferenceCountedObjectBase, DeviceInterface.ICameraV4, IDisposable
    {
        ...
        public Camera()
        {
            try
            {
                ...
                // Create a client
                client = Server.GetClient<AlpacaCamera>(state, TL);
        ...
        public DeviceInterface.CameraStates CameraState
        {
            get
            {
                return (DeviceInterface.CameraStates)client.CameraState;
            }
        }
        ...
        public bool CanAbortExposure
        {
            get
            {
                return client.CanAbortExposure;
            }
        }
        ...
        public bool CanAsymmetricBin
        {
            get
            {
                return client.CanAsymmetricBin;
            }
        }
        ...
        public bool CanGetCoolerPower
        {
            get
            {
                return client.CanGetCoolerPower;
            }
        }
        ...
        public bool CanSetCCDTemperature
        {
            get
            {
                return client.CanSetCCDTemperature;
            }
        }
        ...
        public bool CoolerOn
        {
            get
            {
                return client.CoolerOn;
            }

            set
            {
                client.CoolerOn = value;
            }
        }
        ...
        public double FullWellCapacity
        {
            get
            {
                return client.FullWellCapacity;
            }
        }
        ...
        public double HeatSinkTemperature
        {
            get
            {
                return client.HeatSinkTemperature;
            }
        }
        ...
        public object ImageArrayVariant
        {
            get
            {
                return client.ImageArrayVariant;
            }
        }
        ...
        public double LastExposureDuration
        {
            get
            {
                return client.LastExposureDuration;
            }
        }
        ...
        public string LastExposureStartTime
        {
            get
            {
                return client.LastExposureStartTime;
            }
        }
        ...
        public double SetCCDTemperature
        {
            get
            {
                return client.SetCCDTemperature;
            }

            set
            {
                client.SetCCDTemperature = value;
            }
        }
        ...
        public double ExposureResolution
        {
            get
            {
                return client.ExposureResolution;
            }
        }
        ...
        public bool FastReadout
        {
            get
            {
                return client.FastReadout;
            }

            set
            {
                client.FastReadout = value;
            }
        }
        ...
        public short PercentCompleted
        {
            get
            {
                return client.PercentCompleted;
            }
        }
        ...
        public short ReadoutMode
        {
            get
            {
                return client.ReadoutMode;
            }

            set
            {
                client.ReadoutMode = value;
            }
        }
        ...
        public DeviceInterface.SensorType SensorType
        {
            get
            {
                return (DeviceInterface.SensorType)client.SensorType;
            }
        }
        ...
        public double SubExposureDuration
        {
            get
            {
                return client.SubExposureDuration;
            }
