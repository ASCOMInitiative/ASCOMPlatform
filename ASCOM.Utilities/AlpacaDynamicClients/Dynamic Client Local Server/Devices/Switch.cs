    ...
    public class Switch : ReferenceCountedObjectBase, DeviceInterface.ISwitchV3, IDisposable
    {
        ...
        public Switch()
        {
            try
            {
                ...
                // Create a client
                client = Server.GetClient<AlpacaSwitch>(state, TL);
        ...
        {
            return client.CanWrite(id);

        }

        public bool GetSwitch(short id)
        {
            return client.GetSwitch(id);
        }

        public string GetSwitchDescription(short id)
        {
            return client.GetSwitchDescription(id);
        }
