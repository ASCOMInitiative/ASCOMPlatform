...
namespace ASCOM.Utilities.Interfaces
{
    ...
    internal interface IAlpacaDiscoveryExtra
    {
        ...
        /// </para>
        /// </remarks>
        List<AscomDevice> GetAscomDevices(string deviceType);
    ...
    public interface ITraceLogger
    {
        ...
        /// <remarks></remarks>
        [DispId(3)]
        void LogFinish(string Message, bool HexDump); // Append a full hex dump of the supplied string with a new line
    ...
    public interface ITraceLoggerExtra
    {
        ...
        /// </para>
        /// </remarks>
        bool UseMutexSynchronisation { get; set; }
    }
