...
namespace ASCOM
{
    ...
    /// for each defined method is to throw the ASCOM.MethodNotImplementedException. Note that no default constructor is supplied. Throwing this requires the method name.
    /// </summary>
    /// <remarks>
