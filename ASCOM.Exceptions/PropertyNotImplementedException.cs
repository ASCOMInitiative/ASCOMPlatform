...
namespace ASCOM
{
    ...
    public class PropertyNotImplementedException : NotImplementedException
    {
        ...
        public PropertyNotImplementedException(string property, bool accessorSet) : base(String.Format(CultureInfo.InvariantCulture, csMessage, (accessorSet ? "write" : "read"), property))
        {
        ...
        /// </remarks>
        public PropertyNotImplementedException(string property, string message) : base(property, message)
        {
            this.property = property;
        }
        ...
        public PropertyNotImplementedException(string property, bool accessorSet, Exception inner) : base(String.Format(CultureInfo.InvariantCulture, csMessage, (accessorSet ? "write" : "read"), property), inner)
        {
            this.property = property;
            this.accessorSet = accessorSet;
        }
        ...
        public PropertyNotImplementedException(string message, Exception inner) : base(message, inner)
        {
        }
        ...
        /// Create a new exception
        /// </summary>
        public PropertyNotImplementedException() : base(String.Format(CultureInfo.InvariantCulture, csMessage, "", "Unknown"))
        {
        }
        ...
        /// </summary>
        /// <param name = "message">Exception description</param>
        public PropertyNotImplementedException(string message) : base(message)
        {
        }
        ...
        /// </exception>
        protected PropertyNotImplementedException(SerializationInfo info, StreamingContext context) : base(info, context)
        {
        }
