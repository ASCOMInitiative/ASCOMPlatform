...
namespace ASCOM.DeviceInterface
{
    ...
    public interface IVideoV2
    {
        ...
        /// <para><legacyBold>ICameraV4 Behaviour Clarification</legacyBold> - <see cref="IVideoV2"/> and later clients should use the asynchronous <see cref="Connect"/> / <see cref="Disconnect"/> mechanic 
        /// rather than setting Connected <see langword="true"/> when communicating with <see cref="IVideoV2"/> or later devices.</para>
        /// </remarks>
        /// <revisionHistory visible="true">
        /// <revision visible="true" date="IVideo" version="Platform 6.1">Member added.</revision>
        /// <revision visible="true" date="IVideoV2" version="Platform 7.0">Clients should use the Connect() / Disconnect() mechanic rather than setting Connected TRUE when accessing IVideoV2 or later devices.</revision>
        /// </revisionHistory>
        ...
        /// <revisionHistory visible="true">
        /// <revision visible="true" date="IVideoV2" version="Platform 7.0">Member added.</revision>
        /// </revisionHistory>
        void Connect();
        ...
        /// </remarks>
        /// <revisionHistory visible="true">
        /// <revision visible="true" date="IVideo" version="Platform 6.1">Member present.</revision>
        /// <revision visible="true" date="IVideoV2" version="Platform 7.0">Deprecated, see note above.</revision>
        /// </revisionHistory>
