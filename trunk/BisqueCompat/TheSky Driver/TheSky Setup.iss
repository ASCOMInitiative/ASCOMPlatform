...
Source: "D:\dev\astro\ascom-drivers\TheSky Driver\TheSky Driver.dll"; DestDir: "{app}" ;AfterInstall: RegASCOM(); Flags: regserver
; Optional source files (COM and .NET aware)
Source: "D:\dev\astro\ascom-drivers\TheSky Driver\*"; Excludes: *.zip,*.exe,*.dll, \bin\*, \obj\*; DestDir: "{app}\Source\TheSky Driver"; Tasks: source; Flags: recursesubdirs
Source: "D:\dev\astro\ascom-drivers\TheSky Driver\TheSky Driver-ref.dll"; DestDir: "{app}\Source\TheSky Driver"; Tasks: source;
; TODO: Add other files needed by your driver here (add subfolders above)
Source: "D:\dev\astro\ascom-drivers\TheSky Driver\astro32.dll"; DestDir: "{app}"; Flags: sharedfile
Source: "D:\dev\astro\ascom-drivers\TheSky Driver\astro32.dll"; DestDir: "{app}\Source\TheSky Driver"; Tasks: source;
