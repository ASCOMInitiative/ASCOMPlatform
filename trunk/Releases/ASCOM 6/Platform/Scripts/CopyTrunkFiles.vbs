...
Function CopyAssemblies
        ...
        arrFiles(4) = "C:\ASCOM Trunk\ASCOM.DriverAccess.Platform5\bin\Release\ASCOM.DriverAccess.dll"
        arrFiles(5) = "C:\ASCOM Trunk\ASCOM.IConform\ASCOM.IConform\bin\Release\ASCOM.IConform.dll"
        arrFiles(6) = "C:\ASCOM Trunk\ASCOM.Utilities\ASCOM.Utilities\bin\Release\ASCOM.Utilities.dll"
        arrFiles(7) = "C:\ASCOM Trunk\Interfaces\ASCOMExceptions\bin\Release\ASCOM.Exceptions.dll"
        arrFiles(8) = "C:\ASCOM Trunk\Interfaces\HelperPIAs\ASCOM.Helper.dll"
        arrFiles(9) = "C:\ASCOM Trunk\Interfaces\HelperPIAs\ASCOM.Helper2.dll"
