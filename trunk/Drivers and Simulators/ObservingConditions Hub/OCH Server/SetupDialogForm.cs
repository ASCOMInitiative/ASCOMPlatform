...
namespace ASCOM.Simulator
{
    ...
    public partial class SetupDialogForm : Form
    {
        ...
        private void CmbAveragePeriod_SelectedIndexChanged(object sender, EventArgs e) { NewDeviceSelected(sender); }
        private void CmbCloudCover_SelectedIndexChanged(object sender, EventArgs e) { NewDeviceSelected(sender); }
        private void CmbDewPoint_SelectedIndexChanged(object sender, EventArgs e) { NewDeviceSelected(sender); }
        private void CmbHumidity_SelectedIndexChanged(object sender, EventArgs e) { NewDeviceSelected(sender); }
        private void CmbPressure_SelectedIndexChanged(object sender, EventArgs e) { NewDeviceSelected(sender); }
        private void CmbRainRate_SelectedIndexChanged(object sender, EventArgs e) { NewDeviceSelected(sender); }
        private void CmbSkyBrightness_SelectedIndexChanged(object sender, EventArgs e) { NewDeviceSelected(sender); }
        private void CmbSkyQuality_SelectedIndexChanged(object sender, EventArgs e) { NewDeviceSelected(sender); }
        private void CmbSkySeeing_SelectedIndexChanged(object sender, EventArgs e) { NewDeviceSelected(sender); }
        private void CmbSkyTemperature_SelectedIndexChanged(object sender, EventArgs e) { NewDeviceSelected(sender); }
        private void CmbTemperature_SelectedIndexChanged(object sender, EventArgs e) { NewDeviceSelected(sender); }
        private void CmbWindDirection_SelectedIndexChanged(object sender, EventArgs e) { NewDeviceSelected(sender); }
        private void CmbWindGust_SelectedIndexChanged(object sender, EventArgs e) { NewDeviceSelected(sender); }
        private void CmbWindSpeed_SelectedIndexChanged(object sender, EventArgs e) { NewDeviceSelected(sender); }
        ...
        private void ReadDeviceInformation()
        {
            try
            {
                ...
                // Poblulate the UI controls for each ObservingConditions Hub property with information from the relevant driver
                foreach (string property in Hub.ValidProperties) // Iterate over all the Hub properties
                {
