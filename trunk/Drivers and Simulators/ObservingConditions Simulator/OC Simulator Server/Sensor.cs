...
namespace ASCOM.Simulator
{
    ...
    public class Sensor
    {
        ...
        public void ReadProfile(Profile driverProfile)
        {
            ...
            SimFromValue = Convert.ToDouble(driverProfile.GetValue(OCSimulator.DRIVER_PROGID, OCSimulator.SIMFROMVALUE_PROFILENAME, SensorName, OCSimulator.SimulatorDefaultFromValues[SensorName].ToString()));
            OCSimulator.TL.LogMessage("Sensor.ReadProfile", SensorName + " SimFromValue: " + SimFromValue);

            SimToValue = Convert.ToDouble(driverProfile.GetValue(OCSimulator.DRIVER_PROGID, OCSimulator.SIMTOVALUE_PROFILENAME, SensorName, OCSimulator.SimulatorDefaultToValues[SensorName].ToString()));
            OCSimulator.TL.LogMessage("Sensor.ReadProfile", SensorName + " SimToValue: " + SimToValue);

            IsImplemented = Convert.ToBoolean(driverProfile.GetValue(OCSimulator.DRIVER_PROGID, OCSimulator.IS_IMPLEMENTED_PROFILENAME, SensorName, OCSimulator.IS_IMPLEMENTED_DEFAULT));
            OCSimulator.TL.LogMessage("Sensor.ReadProfile", SensorName + " Is Implemented: " + IsImplemented.ToString());

            ShowNotReady = Convert.ToBoolean(driverProfile.GetValue(OCSimulator.DRIVER_PROGID, OCSimulator.SHOW_NOT_READY_PROFILENAME, SensorName, OCSimulator.SHOW_NOT_READY_DEFAULT));
            OCSimulator.TL.LogMessage("Sensor.ReadProfile", SensorName + " ShowNotReady: " + ShowNotReady.ToString());

            NotReadyDelay = Convert.ToDouble(driverProfile.GetValue(OCSimulator.DRIVER_PROGID, OCSimulator.NOT_READY_DELAY_PROFILENAME, SensorName, OCSimulator.NOT_READY_DELAY_DEFAULT));
        ...
        public void WriteProfile(Profile driverProfile)
        {
            ...
            driverProfile.WriteValue(OCSimulator.DRIVER_PROGID, OCSimulator.SIMFROMVALUE_PROFILENAME, SimFromValue.ToString(), SensorName);

            OCSimulator.TL.LogMessage("Sensor.WriteProfile", SensorName + " SimToValue: " + SimToValue);
            driverProfile.WriteValue(OCSimulator.DRIVER_PROGID, OCSimulator.SIMTOVALUE_PROFILENAME, SimToValue.ToString(), SensorName);

            OCSimulator.TL.LogMessage("Sensor.WriteProfile", SensorName + " Is Implemented: " + IsImplemented);
            driverProfile.WriteValue(OCSimulator.DRIVER_PROGID, OCSimulator.IS_IMPLEMENTED_PROFILENAME, IsImplemented.ToString(), SensorName);

            OCSimulator.TL.LogMessage("Sensor.WriteProfile", SensorName + " ShowNotReady: " + ShowNotReady);
            driverProfile.WriteValue(OCSimulator.DRIVER_PROGID, OCSimulator.SHOW_NOT_READY_PROFILENAME, ShowNotReady.ToString(), SensorName);

            OCSimulator.TL.LogMessage("Sensor.WriteProfile", SensorName + " NotReadyDelay: " + NotReadyDelay);
            driverProfile.WriteValue(OCSimulator.DRIVER_PROGID, OCSimulator.NOT_READY_DELAY_PROFILENAME, NotReadyDelay.ToString(), SensorName);
