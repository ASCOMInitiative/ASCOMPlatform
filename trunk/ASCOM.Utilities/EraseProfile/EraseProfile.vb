...
Module EraseProfile
    Sub Main()
        ...
        TL.LogMessage("EraseProfile", "BaseFolder: " & BaseFolder)
        ...
        If Response = MsgBoxResult.Ok Then
            ...
            Try
                ...
                If Directory.Exists(BaseFolder) Then
                    ...
                    'Set ACL Security
                    TL.LogMessage("EraseProfile", "Setting security on Root directory")
                    Dim dInfo As New DirectoryInfo(BaseFolder)
